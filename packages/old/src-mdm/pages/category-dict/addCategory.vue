      ...
      <n-form  :model="model.data" ref="formRef" :rules="rules">
        <n-grid x-gap="8" :cols="1" >
            ...
            <n-grid-item>
             ...
             <n-grid-item v-if="model.data.parentId=='0'">
                <n-form-item label="字典项别名" path="dictNameAlias">
                    <n-input size="small" placeholder="请输入" v-model:value="model.data.dictNameAlias" />
                </n-form-item>
            </n-grid-item>
            <n-grid-item v-if="model.data.parentId=='0'">
                <n-form-item label="字典项编码别名" path="dictCodeAlias">
                    <n-input size="small" placeholder="请输入" v-model:value="model.data.dictCodeAlias " />
                </n-form-item>
            </n-grid-item>
        </n-grid>
    </n-form>
