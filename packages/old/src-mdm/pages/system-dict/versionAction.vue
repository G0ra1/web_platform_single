  ...
  <n-spin :show="isLoading">
       <n-card style="height:600px">
            ...
            >
                ...
                <vxe-column field="dictItemName" title="字典名称" ></vxe-column>
                <vxe-column field="dictItemCode" title="字典编码" ></vxe-column>
...
import {dictVersionList, settingMainVersion, dictDel } from './api'
  ...
  setup (props,context) {
    ...
    const searchEvent = () =>{
        ...
        if (filterName) {
            ...
            const searchProps = ['dictName', 'dictCode','version']
