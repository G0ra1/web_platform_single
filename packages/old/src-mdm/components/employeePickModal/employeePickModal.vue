...
//   import {   creatJob,editJob,mdmDutyTypeList } from './api' getEmpByUserId
  import { rightList,  } from '../../pages/organization-manage/api'
  import {  empLists,mdmUserIds } from '../../pages/emp-manage/api'
    ...
    const sonFn = (e={}) => {
      ...
      leftSpinShow.value = true
        ...
        if(props.value.length>0) {
            mdmUserIds(props.value.map(d=>d.userId).join(',')).then((r)=>{
