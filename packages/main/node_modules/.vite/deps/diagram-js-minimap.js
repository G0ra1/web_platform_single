import {
  ...
  remove2 as remove,
  require_css_escape
} from "./chunk-OB366FQQ.js";
import {
  __toESM
} from "./chunk-62VDRKYJ.js";

// ../../node_modules/.pnpm/diagram-js-minimap@2.1.1/node_modules/diagram-js-minimap/dist/index.esm.js
var import_css = __toESM(require_css_escape());

// ../../node_modules/.pnpm/diagram-js@8.9.0/node_modules/diagram-js/lib/util/GraphicsUtil.js
...
function Minimap(config, injector, eventBus, canvas, elementRegistry) {
  ...
  componentEvent.bind(this._parent, "wheel", function(event) {
    ...
    var factor = event.deltaMode === 0 ? 0.02 : 0.32;
    var delta = Math.sqrt(
...
Minimap.prototype._createElement = function(element) {
  ...
  if (gfx) {
    ...
    if (visual) {
      ...
      attr2(elementGfx, { id: element.id });
      return elementGfx;
    }
  }
};
...
// dep:diagram-js-minimap
var diagram_js_minimap_default = index_esm_default;
export {
  diagram_js_minimap_default as default
};
