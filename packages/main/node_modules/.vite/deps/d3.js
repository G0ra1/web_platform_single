...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/ascending.js
function ascending(a4, b) {
  return a4 == null || b == null ? NaN : a4 < b ? -1 : a4 > b ? 1 : a4 >= b ? 0 : NaN;
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/descending.js
function descending(a4, b) {
  return a4 == null || b == null ? NaN : b < a4 ? -1 : b > a4 ? 1 : b >= a4 ? 0 : NaN;
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/bisector.js
function bisector(f) {
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/number.js
function number(x4) {
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/bisect.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/blur.js
...
function blurf(radius) {
  ...
  return (T, S, start3, stop, step) => {
    ...
    for (let i = start3, j = stop; i <= j; i += step) {
      ...
      T[i] = (sum5 + t * (S[Math.max(start3, i - s1)] + S[Math.min(stop, i + s1)])) / w;
      sum5 -= S[Math.max(start3, i - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T, S, start3, stop, step) => {
    ...
    for (let i = start3, j = stop; i <= j; i += step) {
      ...
      T[i] = sum5 / w;
      sum5 -= S[Math.max(start3, i - s2)];
    }
  };
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/count.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/cross.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/cumsum.js
function cumsum(values, valueof) {
  var sum5 = 0, index4 = 0;
  return Float64Array.from(values, valueof === void 0 ? (v2) => sum5 += +v2 || 0 : (v2) => sum5 += +valueof(v2, index4++, values) || 0);
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/variance.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/deviation.js
function deviation(values, valueof) {
  const v2 = variance(values, valueof);
  return v2 ? Math.sqrt(v2) : v2;
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/extent.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/fsum.js
var Adder = class {
  constructor() {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+internmap@2.0.3/node_modules/internmap/src/index.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/identity.js
function identity(x4) {
  return x4;
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/group.js
...
function rollup(values, reduce3, ...keys) {
  return nest(values, identity, reduce3, keys);
}
...
function nest(values, map7, reduce3, keys) {
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/permute.js
function permute(source, keys) {
  return Array.from(keys, (key) => source[key]);
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/sort.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/groupSort.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/array.js
var array = Array.prototype;
var slice = array.slice;
var map = array.map;

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/constant.js
function constant(x4) {
  return () => x4;
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/ticks.js
var e10 = Math.sqrt(50);
var e5 = Math.sqrt(10);
var e2 = Math.sqrt(2);
function ticks(start3, stop, count4) {
  var reverse3, i = -1, n, ticks3, step;
  stop = +stop, start3 = +start3, count4 = +count4;
  if (start3 === stop && count4 > 0)
    return [start3];
  if (reverse3 = stop < start3)
    n = start3, start3 = stop, stop = n;
  if ((step = tickIncrement(start3, stop, count4)) === 0 || !isFinite(step))
    return [];
  if (step > 0) {
...
function tickIncrement(start3, stop, count4) {
  var step = (stop - start3) / Math.max(0, count4), power = Math.floor(Math.log(step) / Math.LN10), error = step / Math.pow(10, power);
  return power >= 0 ? (error >= e10 ? 10 : error >= e5 ? 5 : error >= e2 ? 2 : 1) * Math.pow(10, power) : -Math.pow(10, -power) / (error >= e10 ? 10 : error >= e5 ? 5 : error >= e2 ? 2 : 1);
}
function tickStep(start3, stop, count4) {
  var step0 = Math.abs(stop - start3) / Math.max(0, count4), step1 = Math.pow(10, Math.floor(Math.log(step0) / Math.LN10)), error = step0 / step1;
  if (error >= e10)
    step1 *= 10;
  else if (error >= e5)
    step1 *= 5;
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/nice.js
function nice(start3, stop, count4) {
  let prestep;
  while (true) {
    const step = tickIncrement(start3, stop, count4);
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/threshold/sturges.js
function thresholdSturges(values) {
  return Math.ceil(Math.log(count(values)) / Math.LN2) + 1;
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/bin.js
function bin() {
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/max.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/maxIndex.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/min.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/minIndex.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/quickselect.js
function quickselect(array6, k2, left2 = 0, right2 = array6.length - 1, compare) {
  ...
  while (right2 > left2) {
    ...
    if (compare(array6[right2], t) > 0)
      swap(array6, left2, right2);
    while (i < j) {
      swap(array6, i, j), ++i, --j;
      while (compare(array6[i], t) < 0)
        ++i;
      while (compare(array6[j], t) > 0)
        --j;
    }
    if (compare(array6[left2], t) === 0)
      swap(array6, left2, j);
    else
      ++j, swap(array6, j, right2);
    if (j <= k2)
      left2 = j + 1;
    if (k2 <= j)
      right2 = j - 1;
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/greatest.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/quantile.js
...
function quantileIndex(values, p, valueof) {
  ...
  var n, i = Math.floor((n - 1) * p), order = (i2, j) => ascendingDefined(values[i2], values[j]), index4 = quickselect(Uint32Array.from(values, (_, i2) => i2), i, 0, n - 1, order);
  return greatest(index4.subarray(0, i + 1), (i2) => values[i2]);
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/threshold/freedmanDiaconis.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/threshold/scott.js
function thresholdScott(values, min5, max6) {
  return Math.ceil((max6 - min5) * Math.cbrt(count(values)) / (3.49 * deviation(values)));
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/mean.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/median.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/merge.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/mode.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/pairs.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/range.js
function range(start3, stop, step) {
  start3 = +start3, stop = +stop, step = (n = arguments.length) < 2 ? (stop = start3, start3 = 0, 1) : n < 3 ? 1 : +step;
  var i = -1, n = Math.max(0, Math.ceil((stop - start3) / step)) | 0, range5 = new Array(n);
  while (++i < n) {
    range5[i] = start3 + i * step;
  }
  return range5;
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/rank.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/least.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/leastIndex.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/greatestIndex.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/scan.js
function scan(values, compare) {
  const index4 = leastIndex(values, compare);
  return index4 < 0 ? void 0 : index4;
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/shuffle.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/sum.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/transpose.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/zip.js
function zip() {
  return transpose(arguments);
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/every.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/some.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/filter.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/map.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/reduce.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/reverse.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/difference.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/disjoint.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/intersection.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/superset.js
...
// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/subset.js
function subset(values, other) {
  return superset(other, values);
}

// ../../node_modules/.pnpm/d3-array@3.2.0/node_modules/d3-array/src/union.js
...
function axis(orient, scale2) {
  ...
  function axis2(context) {
    var values = tickValues == null ? scale2.ticks ? scale2.ticks.apply(scale2, tickArguments) : scale2.domain() : tickValues, format3 = tickFormat2 == null ? scale2.tickFormat ? scale2.tickFormat.apply(scale2, tickArguments) : identity_default : tickFormat2, spacing = Math.max(tickSizeInner, 0) + tickPadding, range5 = scale2.range(), range0 = +range5[0] + offset, range1 = +range5[range5.length - 1] + offset, position = (scale2.bandwidth ? center : number2)(scale2.copy(), offset), selection3 = context.selection ? context.selection() : context, path3 = selection3.selectAll(".domain").data([null]), tick = selection3.selectAll(".tick").data(values, scale2).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line = tick.select("line"), text = tick.select("text");
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-dispatch@3.0.1/node_modules/d3-dispatch/src/dispatch.js
var noop = { value: () => {
} };
function dispatch() {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/namespaces.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/namespace.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/creator.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selector.js
function none() {
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/select.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/array.js
function array2(x4) {
  return x4 == null ? [] : Array.isArray(x4) ? x4 : Array.from(x4);
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selectorAll.js
function empty2() {
  return [];
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/selectAll.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/matcher.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/selectChild.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/selectChildren.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/filter.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/sparse.js
function sparse_default(update) {
  return new Array(update.length);
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/enter.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/constant.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/data.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/exit.js
function exit_default() {
  return new Selection(this._exit || this._groups.map(sparse_default), this._parents);
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/join.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/merge.js
function merge_default(context) {
  var selection3 = context.selection ? context.selection() : context;
  for (var groups0 = this._groups, groups1 = selection3._groups, m0 = groups0.length, m1 = groups1.length, m3 = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m3; ++j) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/order.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/sort.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/call.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/nodes.js
function nodes_default() {
  return Array.from(this);
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/node.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/size.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/empty.js
function empty_default() {
  return !this.node();
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/each.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/attr.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/window.js
function window_default(node) {
  return node.ownerDocument && node.ownerDocument.defaultView || node.document && node || node.defaultView;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/style.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/property.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/classed.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/text.js
function textRemove() {
  this.textContent = "";
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/html.js
function htmlRemove() {
  this.innerHTML = "";
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/raise.js
function raise() {
  if (this.nextSibling)
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/lower.js
function lower() {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/append.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/insert.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/remove.js
function remove() {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/clone.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/datum.js
function datum_default(value) {
  return arguments.length ? this.property("__data__", value) : this.node().__data__;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/on.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/dispatch.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/iterator.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/selection/index.js
var root = [null];
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/select.js
function select_default2(selector) {
  return typeof selector === "string" ? new Selection([[document.querySelector(selector)]], [document.documentElement]) : new Selection([[selector]], root);
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/local.js
var nextId = 0;
function local() {
  return new Local();
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/sourceEvent.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-selection@3.0.0/node_modules/d3-selection/src/pointer.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-drag@3.0.0/node_modules/d3-drag/src/noevent.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-drag@3.0.0/node_modules/d3-drag/src/nodrag.js
function nodrag_default(view) {
  var root4 = view.document.documentElement, selection3 = select_default2(view).on("dragstart.drag", noevent_default, nonpassivecapture);
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-drag@3.0.0/node_modules/d3-drag/src/event.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-color@3.1.0/node_modules/d3-color/src/define.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-color@3.1.0/node_modules/d3-color/src/color.js
function Color() {
}
var darker = 0.7;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-color@3.1.0/node_modules/d3-color/src/math.js
var radians = Math.PI / 180;
var degrees = 180 / Math.PI;

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-color@3.1.0/node_modules/d3-color/src/lab.js
var K = 18;
var Xn = 0.96422;
var Yn = 1;
var Zn = 0.82521;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-color@3.1.0/node_modules/d3-color/src/cubehelix.js
var A = -0.14861;
var B = 1.78277;
var C = -0.29227;
var D = -0.90649;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/basis.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/basisClosed.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/constant.js
var constant_default3 = (x4) => () => x4;

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/color.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/rgb.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/numberArray.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/array.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/date.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/number.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/object.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/string.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/value.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/round.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/transform/decompose.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/transform/parse.js
var svgNode;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/transform/index.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/zoom.js
var epsilon2 = 1e-12;
function cosh(x4) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/hsl.js
function hsl2(hue3) {
  return function(start3, end) {
    var h = hue3((start3 = hsl(start3)).h, (end = hsl(end)).h), s2 = nogamma(start3.s, end.s), l = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
    return function(t) {
      start3.h = h(t);
      start3.s = s2(t);
      start3.l = l(t);
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/hcl.js
function hcl2(hue3) {
  return function(start3, end) {
    var h = hue3((start3 = hcl(start3)).h, (end = hcl(end)).h), c6 = nogamma(start3.c, end.c), l = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
    return function(t) {
      start3.h = h(t);
      start3.c = c6(t);
      start3.l = l(t);
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/cubehelix.js
function cubehelix2(hue3) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix5(start3, end) {
      var h = hue3((start3 = cubehelix(start3)).h, (end = cubehelix(end)).h), s2 = nogamma(start3.s, end.s), l = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
      return function(t) {
        start3.h = h(t);
        start3.s = s2(t);
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-interpolate@3.0.1/node_modules/d3-interpolate/src/piecewise.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-timer@3.0.1/node_modules/d3-timer/src/timer.js
var frame = 0;
var timeout = 0;
var interval = 0;
var pokeDelay = 1e3;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-timer@3.0.1/node_modules/d3-timer/src/timeout.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/schedule.js
...
var ENDING = 5;
var ENDED = 6;
function schedule_default(node, name, id3, index4, group3, timing) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/interrupt.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/selection/interrupt.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/tween.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/interpolate.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/attr.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/attrTween.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/delay.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/duration.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/ease.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/easeVarying.js
function easeVarying(id3, value) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (typeof v2 !== "function")
      throw new Error();
    set3(this, id3).ease = v2;
  };
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/filter.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/merge.js
function merge_default2(transition3) {
  if (transition3._id !== this._id)
    throw new Error();
  for (var groups0 = this._groups, groups1 = transition3._groups, m0 = groups0.length, m1 = groups1.length, m3 = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m3; ++j) {
    for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge3 = merges[j] = new Array(n), node, i = 0; i < n; ++i) {
      if (node = group0[i] || group1[i]) {
        merge3[i] = node;
      }
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/on.js
function start(name) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/remove.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/select.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/selectAll.js
function selectAll_default3(select) {
  ...
  for (var groups3 = this._groups, m3 = groups3.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group3 = groups3[j], n = group3.length, node, i = 0; i < n; ++i) {
      if (node = group3[i]) {
        for (var children3 = select.call(node, node.__data__, i, group3), child, inherit3 = get2(node, id3), k2 = 0, l = children3.length; k2 < l; ++k2) {
          if (child = children3[k2]) {
            schedule_default(child, name, id3, k2, children3, inherit3);
          }
        }
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/selection.js
var Selection2 = selection_default.prototype.constructor;
function selection_default2() {
  return new Selection2(this._groups, this._parents);
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/style.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/styleTween.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/text.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/textTween.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/transition.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/end.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/index.js
var id = 0;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-ease@3.0.1/node_modules/d3-ease/src/cubic.js
function cubicInOut(t) {
  return ((t *= 2) <= 1 ? t * t * t : (t -= 2) * t * t + 2) / 2;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-ease@3.0.1/node_modules/d3-ease/src/poly.js
var exponent = 3;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-ease@3.0.1/node_modules/d3-ease/src/sin.js
var pi = Math.PI;
var halfPi = pi / 2;

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-ease@3.0.1/node_modules/d3-ease/src/math.js
function tpmt(x4) {
  return (Math.pow(2, -10 * x4) - 9765625e-10) * 1.0009775171065494;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-ease@3.0.1/node_modules/d3-ease/src/bounce.js
var b1 = 4 / 11;
var b2 = 6 / 11;
var b3 = 8 / 11;
var b4 = 3 / 4;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-ease@3.0.1/node_modules/d3-ease/src/back.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-ease@3.0.1/node_modules/d3-ease/src/elastic.js
var tau = 2 * Math.PI;
var amplitude = 1;
var period = 0.3;
var elasticIn = function custom7(a4, p) {
  ...
  elasticIn3.amplitude = function(a5) {
...
var elasticOut = function custom8(a4, p) {
  ...
  elasticOut3.amplitude = function(a5) {
...
var elasticInOut = function custom9(a4, p) {
  ...
  elasticInOut3.amplitude = function(a5) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/selection/transition.js
var defaultTiming = {
  time: null,
  delay: 0,
  duration: 250,
...
function transition_default2(name) {
  ...
  for (var groups3 = this._groups, m3 = groups3.length, j = 0; j < m3; ++j) {
    for (var group3 = groups3[j], n = group3.length, node, i = 0; i < n; ++i) {
      if (node = group3[i]) {
        schedule_default(node, name, id3, i, group3, timing || inherit(node, id3));
      }
    }
  }
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/selection/index.js
...
function brush(dim) {
  var extent3 = defaultExtent, filter5 = defaultFilter, touchable = defaultTouchable, keys = true, listeners = dispatch_default("start", "brush", "end"), handleSize = 6, touchending;
  ...
  brush2.move = function(group3, selection3, event) {
    if (group3.tween) {
  ...
  function redraw() {
    var group3 = select_default2(this), selection3 = local2(this).selection;
    if (selection3) {
      group3.selectAll(".selection").style("display", null).attr("x", selection3[0][0]).attr("y", selection3[0][1]).attr("width", selection3[1][0] - selection3[0][0]).attr("height", selection3[1][1] - selection3[0][1]);
  ...
  function started(event) {
    ...
    if (!filter5.apply(this, arguments))
      return;
    var that = this, type2 = event.target.__data__.type, mode3 = (keys && event.metaKey ? type2 = "overlay" : type2) === "selection" ? MODE_DRAG : keys && event.altKey ? MODE_CENTER : MODE_HANDLE, signX = dim === Y ? null : signsX[type2], signY = dim === X ? null : signsY[type2], state = local2(that), extent4 = state.extent, selection3 = state.selection, W = extent4[0][0], w0, w1, N = extent4[0][1], n0, n1, E3 = extent4[1][0], e0, e1, S = extent4[1][1], s0, s1, dx = 0, dy = 0, moving, shifting = signX && signY && keys && event.shiftKey, lockX, lockY, points = Array.from(event.touches || [event], (t) => {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-path@3.0.1/node_modules/d3-path/src/path.js
var pi3 = Math.PI;
var tau3 = 2 * pi3;
var epsilon4 = 1e-6;
...
function labConvert2(o) {
  ...
  if (!(o instanceof Rgb2))
    o = rgbConvert2(o);
  var r = rgb2lrgb2(o.r), g = rgb2lrgb2(o.g), b = rgb2lrgb2(o.b), y4 = xyz2lab2((0.2225045 * r + 0.7168786 * g + 0.0606169 * b) / Yn2), x4, z;
  if (r === g && g === b)
    x4 = z = y4;
  else {
    x4 = xyz2lab2((0.4360747 * r + 0.3850649 * g + 0.1430804 * b) / Xn2);
    z = xyz2lab2((0.0139322 * r + 0.0971045 * g + 0.7141733 * b) / Zn2);
  }
  return new Lab2(116 * y4 - 16, 500 * (x4 - y4), 200 * (y4 - z), o.opacity);
}
function gray2(l, opacity) {
  return new Lab2(l, 0, 0, opacity == null ? 1 : opacity);
}
function lab3(l, a4, b, opacity) {
  return arguments.length === 1 ? labConvert2(l) : new Lab2(l, a4, b, opacity == null ? 1 : opacity);
}
function Lab2(l, a4, b, opacity) {
  this.l = +l;
  this.a = +a4;
  this.b = +b;
  this.opacity = +opacity;
...
define_default2(Lab2, lab3, extend2(Color2, {
  ...
  rgb() {
    ...
    z = Zn2 * lab2xyz2(z);
    return new Rgb2(
      lrgb2rgb2(3.1338561 * x4 - 1.6168667 * y4 - 0.4906146 * z),
      lrgb2rgb2(-0.9787684 * x4 + 1.9161415 * y4 + 0.033454 * z),
      lrgb2rgb2(0.0719453 * x4 - 0.2289914 * y4 + 1.4052427 * z),
      this.opacity
    );
  }
}));
...
function lch2(l, c6, h, opacity) {
  return arguments.length === 1 ? hclConvert2(l) : new Hcl2(h, c6, l, opacity == null ? 1 : opacity);
}
function hcl3(h, c6, l, opacity) {
  return arguments.length === 1 ? hclConvert2(h) : new Hcl2(h, c6, l, opacity == null ? 1 : opacity);
}
function Hcl2(h, c6, l, opacity) {
  this.h = +h;
  this.c = +c6;
  this.l = +l;
  this.opacity = +opacity;
...
define_default2(Cubehelix2, cubehelix3, extend2(Color2, {
  ...
  rgb() {
    var h = isNaN(this.h) ? 0 : (this.h + 120) * radians2, l = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l * (1 - l), cosh3 = Math.cos(h), sinh3 = Math.sin(h);
    return new Rgb2(
      255 * (l + a4 * (A2 * cosh3 + B2 * sinh3)),
      255 * (l + a4 * (C2 * cosh3 + D2 * sinh3)),
      255 * (l + a4 * (E2 * cosh3)),
      this.opacity
    );
  }
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/ascending.js
function ascending3(a4, b) {
  return a4 == null || b == null ? NaN : a4 < b ? -1 : a4 > b ? 1 : a4 >= b ? 0 : NaN;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/descending.js
function descending2(a4, b) {
  return a4 == null || b == null ? NaN : b < a4 ? -1 : b > a4 ? 1 : b >= a4 ? 0 : NaN;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/bisector.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/number.js
function number3(x4) {
  return x4 === null ? NaN : +x4;
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/bisect.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/blur.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/count.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/extent.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/fsum.js
var Adder2 = class {
  constructor() {
    this._partials = new Float64Array(32);
    this._n = 0;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/sort.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/array.js
var array3 = Array.prototype;
var slice3 = array3.slice;
var map3 = array3.map;

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/ticks.js
var e102 = Math.sqrt(50);
var e52 = Math.sqrt(10);
var e22 = Math.sqrt(2);
function ticks2(start3, stop, count4) {
  var reverse3, i = -1, n, ticks3, step;
  stop = +stop, start3 = +start3, count4 = +count4;
  if (start3 === stop && count4 > 0)
    return [start3];
  if (reverse3 = stop < start3)
    n = start3, start3 = stop, stop = n;
  if ((step = tickIncrement2(start3, stop, count4)) === 0 || !isFinite(step))
    return [];
  if (step > 0) {
    let r0 = Math.round(start3 / step), r1 = Math.round(stop / step);
    if (r0 * step < start3)
...
function tickIncrement2(start3, stop, count4) {
  var step = (stop - start3) / Math.max(0, count4), power = Math.floor(Math.log(step) / Math.LN10), error = step / Math.pow(10, power);
...
function tickStep2(start3, stop, count4) {
  var step0 = Math.abs(stop - start3) / Math.max(0, count4), step1 = Math.pow(10, Math.floor(Math.log(step0) / Math.LN10)), error = step0 / step1;
  if (error >= e102)
    step1 *= 10;
  else if (error >= e52)
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/threshold/sturges.js
function thresholdSturges2(values) {
  return Math.ceil(Math.log(count2(values)) / Math.LN2) + 1;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/max.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/min.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/quickselect.js
function quickselect2(array6, k2, left2 = 0, right2 = array6.length - 1, compare) {
  ...
  while (right2 > left2) {
    if (right2 - left2 > 600) {
      ...
      const newLeft = Math.max(left2, Math.floor(k2 - m3 * s2 / n + sd));
      const newRight = Math.min(right2, Math.floor(k2 + (n - m3) * s2 / n + sd));
      quickselect2(array6, k2, newLeft, newRight, compare);
    }
    const t = array6[k2];
    let i = left2;
    let j = right2;
    swap2(array6, left2, k2);
    if (compare(array6[right2], t) > 0)
      swap2(array6, left2, right2);
    while (i < j) {
      swap2(array6, i, j), ++i, --j;
      while (compare(array6[i], t) < 0)
        ++i;
      while (compare(array6[j], t) > 0)
        --j;
    ...
    if (compare(array6[left2], t) === 0)
      swap2(array6, left2, j);
    else
      ++j, swap2(array6, j, right2);
    if (j <= k2)
      left2 = j + 1;
    if (k2 <= j)
      right2 = j - 1;
...
function swap2(array6, i, j) {
  const t = array6[i];
  array6[i] = array6[j];
  array6[j] = t;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/quantile.js
function quantile2(values, p, valueof) {
  ...
  if (p >= 1)
    return max4(values);
  var n, i = (n - 1) * p, i0 = Math.floor(i), value0 = max4(quickselect2(values, i0).subarray(0, i0 + 1)), value1 = min3(values.subarray(i0 + 1));
  return value0 + (value1 - value0) * (i - i0);
}
function quantileSorted2(values, p, valueof = number3) {
  if (!(n = values.length))
    return;
  if ((p = +p) <= 0 || n < 2)
    return +valueof(values[0], 0, values);
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/merge.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/range.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-array@3.2.0/node_modules/d3-array/src/shuffle.js
...
// ../../node_modules/.pnpm/d3-contour@4.0.0/node_modules/d3-contour/src/array.js
var array4 = Array.prototype;
var slice4 = array4.slice;

// ../../node_modules/.pnpm/d3-contour@4.0.0/node_modules/d3-contour/src/ascending.js
function ascending_default(a4, b) {
  return a4 - b;
}

// ../../node_modules/.pnpm/d3-contour@4.0.0/node_modules/d3-contour/src/area.js
...
// ../../node_modules/.pnpm/d3-contour@4.0.0/node_modules/d3-contour/src/constant.js
var constant_default6 = (x4) => () => x4;

// ../../node_modules/.pnpm/d3-contour@4.0.0/node_modules/d3-contour/src/contains.js
...
function ringContains(ring, point6) {
  ...
  for (var i = 0, n = ring.length, j = n - 1; i < n; j = i++) {
    var pi8 = ring[i], xi = pi8[0], yi = pi8[1], pj = ring[j], xj = pj[0], yj = pj[1];
    if (segmentContains(pi8, pj, point6))
      return 0;
...
// ../../node_modules/.pnpm/d3-contour@4.0.0/node_modules/d3-contour/src/noop.js
function noop_default() {
}

// ../../node_modules/.pnpm/d3-contour@4.0.0/node_modules/d3-contour/src/contours.js
var cases = [
  [],
  [[[1, 1.5], [0.5, 1]]],
  [[[1.5, 1], [1, 1.5]]],
...
function contours_default() {
  ...
  function contours(values) {
    ...
    if (!Array.isArray(tz)) {
      const e = extent2(values), ts = tickStep2(e[0], e[1], tz);
      tz = ticks2(Math.floor(e[0] / ts) * ts, Math.floor(e[1] / ts - 1) * ts, tz);
    } else {
  ...
  function isorings(values, value, callback) {
    var fragmentByStart = new Array(), fragmentByEnd = new Array(), x4, y4, t05, t15, t23, t33;
    x4 = y4 = -1;
    t15 = values[0] >= value;
    cases[t15 << 1].forEach(stitch);
    while (++x4 < dx - 1) {
      t05 = t15, t15 = values[x4 + 1] >= value;
      cases[t05 | t15 << 1].forEach(stitch);
    }
    cases[t15 << 0].forEach(stitch);
    while (++y4 < dy - 1) {
      x4 = -1;
      t15 = values[y4 * dx + dx] >= value;
      t23 = values[y4 * dx] >= value;
      cases[t15 << 1 | t23 << 2].forEach(stitch);
      while (++x4 < dx - 1) {
        t05 = t15, t15 = values[y4 * dx + dx + x4 + 1] >= value;
        t33 = t23, t23 = values[y4 * dx + x4 + 1] >= value;
    ...
    function stitch(line) {
      var start3 = [line[0][0] + x4, line[0][1] + y4], end = [line[1][0] + x4, line[1][1] + y4], startIndex = index4(start3), endIndex = index4(end), f, g;
...
// ../../node_modules/.pnpm/d3-contour@4.0.0/node_modules/d3-contour/src/density.js
function defaultX(d) {
  return d[0];
}
function defaultY(d) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+robust-predicates@3.0.1/node_modules/robust-predicates/esm/util.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+robust-predicates@3.0.1/node_modules/robust-predicates/esm/orient2d.js
...
function orient2dadapt(ax, ay, bx, by, cx, cy, detsum) {
  ...
  _i = s0 - t05;
  bvirt = s0 - _i;
  B3[0] = s0 - (_i + bvirt) + (bvirt - t05);
  _j = s1 + _i;
  bvirt = _j - s1;
  _0 = s1 - (_j - bvirt) + (_i - bvirt);
  _i = _0 - t15;
  bvirt = _0 - _i;
  B3[1] = _0 - (_i + bvirt) + (bvirt - t15);
  u32 = _j + _i;
  bvirt = u32 - _j;
  ...
  u[2] = _j - (u32 - bvirt) + (_i - bvirt);
  u[3] = u32;
  const Dlen = sum3(C2len, C22, 4, u, D3);
  return D3[Dlen - 1];
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+robust-predicates@3.0.1/node_modules/robust-predicates/esm/orient3d.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+robust-predicates@3.0.1/node_modules/robust-predicates/esm/incircle.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+robust-predicates@3.0.1/node_modules/robust-predicates/esm/insphere.js
...
// ../../node_modules/.pnpm/d3-delaunay@6.0.2/node_modules/d3-delaunay/src/path.js
var epsilon6 = 1e-6;
var Path2 = class {
  constructor() {
    this._x0 = this._y0 = this._x1 = this._y1 = null;
...
// ../../node_modules/.pnpm/d3-delaunay@6.0.2/node_modules/d3-delaunay/src/polygon.js
var Polygon = class {
  constructor() {
    this._ = [];
  }
...
// ../../node_modules/.pnpm/d3-delaunay@6.0.2/node_modules/d3-delaunay/src/voronoi.js
var Voronoi = class {
...
// ../../node_modules/.pnpm/d3-delaunay@6.0.2/node_modules/d3-delaunay/src/delaunay.js
var tau4 = 2 * Math.PI;
var pow = Math.pow;
function pointX(p) {
  return p[0];
...
function nodrag_default2(view) {
  var root4 = view.document.documentElement, selection3 = select_default2(view).on("dragstart.drag", noevent_default3, nonpassivecapture2);
  if ("onselectstart" in root4) {
    selection3.on("selectstart.drag", noevent_default3, nonpassivecapture2);
  } else {
    root4.__noselect = root4.style.MozUserSelect;
    root4.style.MozUserSelect = "none";
  }
...
function yesdrag2(view, noclick) {
  var root4 = view.document.documentElement, selection3 = select_default2(view).on("dragstart.drag", null);
  if (noclick) {
    selection3.on("click.drag", noevent_default3, nonpassivecapture2);
    setTimeout(function() {
      selection3.on("click.drag", null);
    }, 0);
  }
...
function drag_default2() {
  var filter5 = defaultFilter2, container = defaultContainer, subject = defaultSubject, touchable = defaultTouchable2, gestures = {}, listeners = dispatch_default("start", "drag", "end"), active = 0, mousedownx, mousedowny, mousemoving, touchending, clickDistance2 = 0;
  ...
  function mousedowned(event, d) {
    if (touchending || !filter5.call(this, event, d))
      return;
    var gesture = beforestart(this, container.call(this, event, d), event, d, "mouse");
    if (!gesture)
      return;
    select_default2(event.view).on("mousemove.drag", mousemoved, nonpassivecapture2).on("mouseup.drag", mouseupped, nonpassivecapture2);
  ...
  function beforestart(that, container2, event, d, identifier, touch) {
    ...
    if ((s2 = subject.call(that, new DragEvent2("beforestart", {
      sourceEvent: event,
      target: drag,
      identifier,
      active,
  ...
  drag.filter = function(_) {
    return arguments.length ? (filter5 = typeof _ === "function" ? _ : constant_default7(!!_), drag) : filter5;
  };
  drag.container = function(_) {
    return arguments.length ? (container = typeof _ === "function" ? _ : constant_default7(_), drag) : container;
  };
  drag.subject = function(_) {
    return arguments.length ? (subject = typeof _ === "function" ? _ : constant_default7(_), drag) : subject;
  };
  drag.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default7(!!_), drag) : touchable;
  };
  drag.on = function() {
    var value = listeners.on.apply(listeners, arguments);
...
var amplitude2 = 1;
var period2 = 0.3;
var elasticIn2 = function custom16(a4, p) {
  var s2 = Math.asin(1 / (a4 = Math.max(1, a4))) * (p /= tau5);
  function elasticIn3(t) {
    return a4 * tpmt2(- --t) * Math.sin((s2 - t) / p);
  }
  elasticIn3.amplitude = function(a5) {
    return custom16(a5, p * tau5);
  };
  elasticIn3.period = function(p2) {
    return custom16(a4, p2);
  };
  return elasticIn3;
}(amplitude2, period2);
var elasticOut2 = function custom17(a4, p) {
  var s2 = Math.asin(1 / (a4 = Math.max(1, a4))) * (p /= tau5);
  function elasticOut3(t) {
    return 1 - a4 * tpmt2(t = +t) * Math.sin((t + s2) / p);
  }
  elasticOut3.amplitude = function(a5) {
    return custom17(a5, p * tau5);
  };
  elasticOut3.period = function(p2) {
    return custom17(a4, p2);
  };
  return elasticOut3;
}(amplitude2, period2);
var elasticInOut2 = function custom18(a4, p) {
  var s2 = Math.asin(1 / (a4 = Math.max(1, a4))) * (p /= tau5);
  function elasticInOut3(t) {
    return ((t = t * 2 - 1) < 0 ? a4 * tpmt2(-t) * Math.sin((s2 - t) / p) : 2 - a4 * tpmt2(t) * Math.sin((s2 + t) / p)) / 2;
  }
  elasticInOut3.amplitude = function(a5) {
    return custom18(a5, p * tau5);
  };
  elasticInOut3.period = function(p2) {
    return custom18(a4, p2);
  };
  return elasticInOut3;
}(amplitude2, period2);
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-dsv@3.0.1/node_modules/d3-dsv/src/dsv.js
var EOL2 = {};
var EOF2 = {};
var QUOTE2 = 34;
var NEWLINE2 = 10;
...
function formatDate2(date2) {
  var hours3 = date2.getUTCHours(), minutes3 = date2.getUTCMinutes(), seconds3 = date2.getUTCSeconds(), milliseconds3 = date2.getUTCMilliseconds();
  return isNaN(date2) ? "Invalid Date" : formatYear2(date2.getUTCFullYear(), 4) + "-" + pad2(date2.getUTCMonth() + 1, 2) + "-" + pad2(date2.getUTCDate(), 2) + (milliseconds3 ? "T" + pad2(hours3, 2) + ":" + pad2(minutes3, 2) + ":" + pad2(seconds3, 2) + "." + pad2(milliseconds3, 3) + "Z" : seconds3 ? "T" + pad2(hours3, 2) + ":" + pad2(minutes3, 2) + ":" + pad2(seconds3, 2) + "Z" : minutes3 || hours3 ? "T" + pad2(hours3, 2) + ":" + pad2(minutes3, 2) + "Z" : "");
}
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-dsv@3.0.1/node_modules/d3-dsv/src/csv.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-dsv@3.0.1/node_modules/d3-dsv/src/tsv.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-dsv@3.0.1/node_modules/d3-dsv/src/autoType.js
...
function dsv(delimiter, input, init3, row) {
  if (arguments.length === 3 && typeof init3 === "function")
    row = init3, init3 = void 0;
  var format3 = dsv_default2(delimiter);
  return text_default3(input, init3).then(function(response) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/add.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/cover.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/data.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/extent.js
function extent_default(_) {
  return arguments.length ? this.cover(+_[0][0], +_[0][1]).cover(+_[1][0], +_[1][1]) : isNaN(this._x0) ? void 0 : [[this._x0, this._y0], [this._x1, this._y1]];
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/quad.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/find.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/remove.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/root.js
function root_default() {
  return this._root;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/size.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/visit.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/visitAfter.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/x.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/y.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-quadtree@3.0.1/node_modules/d3-quadtree/src/quadtree.js
...
function link_default(links) {
  var id3 = index3, strength = defaultStrength, strengths, distance = constant_default8(30), distances, nodes, count4, bias, random, iterations2 = 1;
  if (links == null)
    links = [];
  ...
  function initialize() {
    if (!nodes)
      return;
    var i, n = nodes.length, m3 = links.length, nodeById = new Map(nodes.map((d, i2) => [id3(d, i2, nodes), d])), link3;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/math.js
var epsilon7 = 1e-6;
var epsilon22 = 1e-12;
var pi5 = Math.PI;
var halfPi4 = pi5 / 2;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/noop.js
function noop3() {
}

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/stream.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/area.js
var areaRingSum = new Adder2();
var areaSum = new Adder2();
var lambda00;
var phi00;
var lambda0;
var cosPhi0;
...
var areaStream = {
  ...
  polygonEnd: function() {
    ...
    areaSum.add(areaRing < 0 ? tau6 + areaRing : areaRing);
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/cartesian.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/bounds.js
var lambda02;
var phi0;
var lambda1;
var phi1;
...
function linePoint(lambda, phi2) {
  ...
  if (p0) {
    ...
    var delta = lambda - lambda2, sign3 = delta > 0 ? 1 : -1, lambdai = inflection[0] * degrees4 * sign3, phii, antimeridian = abs3(delta) > 180;
    if (antimeridian ^ (sign3 * lambda2 < lambdai && lambdai < sign3 * lambda)) {
      phii = inflection[1] * degrees4;
      if (phii > phi1)
        phi1 = phii;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/centroid.js
var W0;
var W1;
var X0;
var Y0;
...
function centroid_default(object2) {
  ...
  return [atan2(y4, x4) * degrees4, asin(z / m3) * degrees4];
}

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/constant.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/compose.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/rotation.js
function rotationIdentity(lambda, phi2) {
  return [abs3(lambda) > pi5 ? lambda + Math.round(-lambda / tau6) * tau6 : lambda, phi2];
}
...
function forwardRotationLambda(deltaLambda) {
  return function(lambda, phi2) {
    return lambda += deltaLambda, [lambda > pi5 ? lambda - tau6 : lambda < -pi5 ? lambda + tau6 : lambda, phi2];
  };
}
...
function rotation_default(rotate) {
  rotate = rotateRadians(rotate[0] * radians3, rotate[1] * radians3, rotate.length > 2 ? rotate[2] * radians3 : 0);
  function forward(coordinates2) {
    coordinates2 = rotate(coordinates2[0] * radians3, coordinates2[1] * radians3);
    return coordinates2[0] *= degrees4, coordinates2[1] *= degrees4, coordinates2;
  }
  forward.invert = function(coordinates2) {
    coordinates2 = rotate.invert(coordinates2[0] * radians3, coordinates2[1] * radians3);
    return coordinates2[0] *= degrees4, coordinates2[1] *= degrees4, coordinates2;
  };
  return forward;
}

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/circle.js
...
function circleRadius(cosRadius, point6) {
  ...
  return ((-point6[2] < 0 ? -radius : radius) + tau6 - epsilon7) % tau6;
}
function circle_default() {
  ...
  function point6(x4, y4) {
    ...
    x4[0] *= degrees4, x4[1] *= degrees4;
  }
  function circle2() {
    var c6 = center2.apply(this, arguments), r = radius.apply(this, arguments) * radians3, p = precision.apply(this, arguments) * radians3;
    ring = [];
    rotate = rotateRadians(-c6[0] * radians3, -c6[1] * radians3, 0).invert;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/clip/buffer.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/pointEqual.js
function pointEqual_default(a4, b) {
  return abs3(a4[0] - b[0]) < epsilon7 && abs3(a4[1] - b[1]) < epsilon7;
}

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/clip/rejoin.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/polygonContains.js
function longitude(point6) {
  return abs3(point6[0]) <= pi5 ? point6[0] : sign(point6[0]) * ((abs3(point6[0]) + pi5) % tau6 - pi5);
}
function polygonContains_default(polygon, point6) {
  ...
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (var j = 0; j < m3; ++j, lambda04 = lambda12, sinPhi03 = sinPhi1, cosPhi03 = cosPhi1, point0 = point1) {
      ...
      angle2 += antimeridian ? delta + sign3 * tau6 : delta;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/clip/index.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/clip/antimeridian.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/clip/circle.js
function circle_default2(radius) {
  var cr = cos2(radius), delta = 6 * radians3, smallRadius = cr > 0, notHemisphere = abs3(cr) > epsilon7;
  ...
  function clipLine(stream) {
    ...
    return {
      ...
      point: function(lambda, phi2) {
        var point1 = [lambda, phi2], point22, v2 = visible(lambda, phi2), c6 = smallRadius ? v2 ? 0 : code(lambda, phi2) : v2 ? code(lambda + (lambda < 0 ? pi5 : -pi5), phi2) : 0;
        if (!point0 && (v00 = v0 = v2))
          stream.lineStart();
        if (v2 !== v0) {
  ...
  function intersect2(a4, b, two) {
    ...
    var u4 = n1xn2, w = cartesianDot(A5, u4), uu = cartesianDot(u4, u4), t23 = w * w - uu * (cartesianDot(A5, A5) - 1);
    if (t23 < 0)
      return;
    var t = sqrt(t23), q = cartesianScale(u4, (-w - t) / uu);
    ...
    var delta2 = lambda12 - lambda04, polar = abs3(delta2 - pi5) < epsilon7, meridian = polar || delta2 < epsilon7;
    if (!polar && phi12 < phi02)
      z = phi02, phi02 = phi12, phi12 = z;
    if (meridian ? polar ? phi02 + phi12 > 0 ^ q[1] < (abs3(q[0] - lambda04) < epsilon7 ? phi02 : phi12) : phi02 <= q[1] && q[1] <= phi12 : delta2 > pi5 ^ (lambda04 <= q[0] && q[0] <= lambda12)) {
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/clip/line.js
function line_default(a4, b, x06, y06, x12, y12) {
  ...
  if (t05 > 0)
    a4[0] = ax + t05 * dx, a4[1] = ay + t05 * dy;
  if (t15 < 1)
    b[0] = ax + t15 * dx, b[1] = ay + t15 * dy;
  return true;
}

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/clip/rectangle.js
var clipMax = 1e9;
var clipMin = -clipMax;
function clipRectangle(x06, y06, x12, y12) {
  ...
  return function(stream) {
    ...
    function polygonInside() {
      var winding = 0;
      for (var i = 0, n = polygon.length; i < n; ++i) {
        for (var ring2 = polygon[i], j = 1, m3 = ring2.length, point7 = ring2[0], a0, a1, b03 = point7[0], b13 = point7[1]; j < m3; ++j) {
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/clip/extent.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/length.js
var lengthSum;
var lambda03;
var sinPhi02;
var cosPhi02;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/distance.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/contains.js
...
function pointRadians(point6) {
  return [point6[0] * radians3, point6[1] * radians3];
}
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/graticule.js
function graticuleX(y06, y12, dy) {
  var y4 = range3(y06, y12 - epsilon7, dy).concat(y12);
  return function(x4) {
...
function graticuleY(x06, x12, dx) {
  var x4 = range3(x06, x12 - epsilon7, dx).concat(x12);
  return function(y4) {
...
function graticule() {
  ...
  function lines() {
    return range3(ceil(X03 / DX) * DX, X13, DX).map(X3).concat(range3(ceil(Y03 / DY) * DY, Y13, DY).map(Y3)).concat(range3(ceil(x06 / dx) * dx, x12, dx).filter(function(x5) {
      return abs3(x5 % DX) > epsilon7;
    }).map(x4)).concat(range3(ceil(y06 / dy) * dy, y12, dy).filter(function(y5) {
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/interpolate.js
function interpolate_default2(a4, b) {
  var x06 = a4[0] * radians3, y06 = a4[1] * radians3, x12 = b[0] * radians3, y12 = b[1] * radians3, cy0 = cos2(y06), sy0 = sin2(y06), cy1 = cos2(y12), sy1 = sin2(y12), kx0 = cy0 * cos2(x06), ky0 = cy0 * sin2(x06), kx1 = cy1 * cos2(x12), ky1 = cy1 * sin2(x12), d = 2 * asin(sqrt(haversin(y12 - y06) + cy0 * cy1 * haversin(x12 - x06))), k2 = sin2(d);
  var interpolate = d ? function(t) {
    var B4 = sin2(t *= d) / k2, A5 = sin2(d - t) / k2, x4 = A5 * kx0 + B4 * kx1, y4 = A5 * ky0 + B4 * ky1, z = A5 * sy0 + B4 * sy1;
    return [
      atan2(y4, x4) * degrees4,
      atan2(z, sqrt(x4 * x4 + y4 * y4)) * degrees4
    ];
  } : function() {
    return [x06 * degrees4, y06 * degrees4];
  };
  interpolate.distance = d;
  return interpolate;
}

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/identity.js
var identity_default3 = (x4) => x4;

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/path/area.js
var areaSum2 = new Adder2();
var areaRingSum2 = new Adder2();
var x00;
var y00;
var x02;
var y02;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/path/bounds.js
var x03 = Infinity;
var y03 = x03;
var x1 = -x03;
var y1 = x1;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/path/centroid.js
var X02 = 0;
var Y02 = 0;
var Z02 = 0;
var X12 = 0;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/path/context.js
  ...
  point: function(x4, y4) {
    switch (this._point) {
      ...
      default: {
        ...
        this._context.arc(x4, y4, this._radius, 0, tau6);
        break;
      }
    }
  },
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/path/measure.js
var lengthSum2 = new Adder2();
var lengthRing;
var x003;
var y003;
var x05;
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/path/string.js
function PathString() {
  this._string = [];
}
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/path/index.js
function path_default2(projection2, context) {
  ...
  path3.projection = function(_) {
    return arguments.length ? (projectionStream = _ == null ? (projection2 = null, identity_default3) : (projection2 = _).stream, path3) : projection2;
  };
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/transform.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/fit.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/resample.js
var maxDepth = 16;
...
function resample(project, delta2) {
  function resampleLineTo(x06, y06, lambda04, a0, b03, c0, x12, y12, lambda12, a1, b13, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a4 = a0 + a1, b = b03 + b13, c6 = c0 + c1, m3 = sqrt(a4 * a4 + b * b + c6 * c6), phi2 = asin(c6 /= m3), lambda22 = abs3(abs3(c6) - 1) < epsilon7 || abs3(lambda04 - lambda12) < epsilon7 ? (lambda04 + lambda12) / 2 : atan2(b, a4), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
      if (dz * dz / d2 > delta2 || abs3((dx * dx2 + dy * dy2) / d2 - 0.5) > 0.3 || a0 * a1 + b03 * b13 + c0 * c1 < cosMinDistance) {
        resampleLineTo(x06, y06, lambda04, a0, b03, c0, x22, y22, lambda22, a4 /= m3, b /= m3, c6, depth, stream);
        stream.point(x22, y22);
        resampleLineTo(x22, y22, lambda22, a4, b, c6, x12, y12, lambda12, a1, b13, c1, depth, stream);
      }
    }
  }
  return function(stream) {
    ...
    function linePoint2(lambda, phi2) {
      ...
      resampleLineTo(x06, y06, lambda04, a0, b03, c0, x06 = p[0], y06 = p[1], lambda04 = lambda, a0 = c6[0], b03 = c6[1], c0 = c6[2], maxDepth, stream);
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/index.js
var transformRadians = transformer({
  point: function(x4, y4) {
    this.stream.point(x4 * radians3, y4 * radians3);
  }
});
...
function projectionMutator(projectAt) {
  ...
  function projection2(point6) {
    return projectRotateTransform(point6[0] * radians3, point6[1] * radians3);
  }
  function invert(point6) {
    point6 = projectRotateTransform.invert(point6[0], point6[1]);
    return point6 && [point6[0] * degrees4, point6[1] * degrees4];
  }
  ...
  projection2.clipAngle = function(_) {
    return arguments.length ? (preclip = +_ ? circle_default2(theta = _ * radians3) : (theta = null, antimeridian_default), reset()) : theta * degrees4;
  };
  ...
  projection2.center = function(_) {
    return arguments.length ? (lambda = _[0] % 360 * radians3, phi2 = _[1] % 360 * radians3, recenter()) : [lambda * degrees4, phi2 * degrees4];
  };
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/conic.js
function conicProjection(projectAt) {
  var phi02 = 0, phi12 = pi5 / 3, m3 = projectionMutator(projectAt), p = m3(phi02, phi12);
  p.parallels = function(_) {
    return arguments.length ? m3(phi02 = _[0] * radians3, phi12 = _[1] * radians3) : [phi02 * degrees4, phi12 * degrees4];
  };
  return p;
}

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/cylindricalEqualArea.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/conicEqualArea.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/albers.js
function albers_default() {
  return conicEqualArea_default().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
}

// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/albersUsa.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/azimuthal.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/azimuthalEqualArea.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/azimuthalEquidistant.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/mercator.js
function mercatorRaw(lambda, phi2) {
  return [lambda, log(tan((halfPi4 + phi2) / 2))];
}
mercatorRaw.invert = function(x4, y4) {
  return [x4, 2 * atan(exp(y4)) - halfPi4];
};
...
function mercatorProjection(project) {
  ...
  function reclip() {
    var k2 = pi5 * scale2(), t = m3(rotation_default(m3.rotate()).invert([0, 0]));
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/conicConformal.js
function tany(y4) {
  return tan((halfPi4 + y4) / 2);
}
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/equirectangular.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/conicEquidistant.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/equalEarth.js
var A1 = 1.340264;
var A22 = -0.081106;
var A3 = 893e-6;
var A4 = 3796e-6;
...
equalEarthRaw.invert = function(x4, y4) {
  ...
  return [
    M * x4 * (A1 + 3 * A22 * l2 + l6 * (7 * A3 + 9 * A4 * l2)) / cos2(l),
    asin(sin2(l) / M)
  ];
};
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/gnomonic.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/identity.js
function identity_default4() {
  ...
  projection2.angle = function(_) {
    return arguments.length ? (alpha = _ % 360 * radians3, sa = sin2(alpha), ca3 = cos2(alpha), reset()) : alpha * degrees4;
  };
  projection2.reflectX = function(_) {
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/naturalEarth1.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/orthographic.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/stereographic.js
...
// ../../node_modules/.pnpm/d3-geo@3.0.1/node_modules/d3-geo/src/projection/transverseMercator.js
function transverseMercatorRaw(lambda, phi2) {
  return [log(tan((halfPi4 + phi2) / 2)), -lambda];
}
transverseMercatorRaw.invert = function(x4, y4) {
  return [-y4, 2 * atan(exp(x4)) - halfPi4];
};
...
function sum_default(value) {
  return this.eachAfter(function(node) {
    var sum5 = +value(node.data) || 0, children3 = node.children, i = children3 && children3.length;
    while (--i >= 0)
      sum5 += children3[i].value;
    node.value = sum5;
  });
...
function encloseBasis3(a4, b, c6) {
  var x12 = a4.x, y12 = a4.y, r1 = a4.r, x22 = b.x, y22 = b.y, r2 = b.r, x32 = c6.x, y32 = c6.y, r3 = c6.r, a22 = x12 - x22, a32 = x12 - x32, b23 = y12 - y22, b33 = y12 - y32, c22 = r2 - r1, c32 = r3 - r1, d1 = x12 * x12 + y12 * y12 - r1 * r1, d2 = d1 - x22 * x22 - y22 * y22 + r2 * r2, d3 = d1 - x32 * x32 - y32 * y32 + r3 * r3, ab4 = a32 * b23 - a22 * b33, xa = (b23 * d3 - b33 * d2) / (ab4 * 2) - x12, xb = (b33 * c22 - b23 * c32) / ab4, ya = (a32 * d2 - a22 * d3) / (ab4 * 2) - y12, yb = (a22 * c32 - a32 * c22) / ab4, A5 = xb * xb + yb * yb - 1, B4 = 2 * (r1 + xa * xb + ya * yb), C3 = xa * xa + ya * ya - r1 * r1, r = -(Math.abs(A5) > 1e-6 ? (B4 + Math.sqrt(B4 * B4 - 4 * A5 * C3)) / (2 * A5) : C3 / B4);
  return {
    x: x12 + xa + xb * r,
    y: y12 + ya + yb * r,
    r
...
function place(b, a4, c6) {
  var dx = b.x - a4.x, x4, a22, dy = b.y - a4.y, y4, b23, d2 = dx * dx + dy * dy;
  if (d2) {
    a22 = a4.r + c6.r, a22 *= a22;
    b23 = b.r + c6.r, b23 *= b23;
    if (a22 > b23) {
      x4 = (d2 + b23 - a22) / (2 * d2);
      y4 = Math.sqrt(Math.max(0, b23 / d2 - x4 * x4));
...
function pack_default() {
  ...
  function pack(root4) {
    ...
    if (radius) {
      root4.eachBefore(radiusLeaf(radius)).eachAfter(packChildrenRandom(padding, 0.5, random)).eachBefore(translateChild(1));
    } else {
      root4.eachBefore(radiusLeaf(defaultRadius2)).eachAfter(packChildrenRandom(constantZero, 1, random)).eachAfter(packChildrenRandom(padding, root4.r / Math.min(dx, dy), random)).eachBefore(translateChild(Math.min(dx, dy) / (2 * root4.r)));
    }
    return root4;
  }
...
function packChildrenRandom(padding, k2, random) {
  return function(node) {
    if (children3 = node.children) {
      var children3, i, n = children3.length, r = padding(node) * k2 || 0, e;
      if (r)
        for (i = 0; i < n; ++i)
          children3[i].r += r;
...
function stratify_default() {
  ...
  function stratify(data) {
    var nodes = Array.from(data), currentId = id3, currentParentId = parentId, n, d, i, root4, parent, node, nodeId, nodeKey, nodeByKey = /* @__PURE__ */ new Map();
    if (path3 != null) {
    ...
    if (path3 != null) {
      while (root4.data === imputed && root4.children.length === 1) {
        root4 = root4.children[0], --n;
      }
...
function executeShifts(v2) {
  var shift = 0, change = 0, children3 = v2.children, i = children3.length, w;
  while (--i >= 0) {
    w = children3[i];
    w.z += shift;
    w.m += shift;
...
function treeRoot(root4) {
  var tree = new TreeNode(root4, 0), node, nodes = [tree], child, children3, i, n;
  while (node = nodes.pop()) {
...
function tree_default() {
  ...
  function firstWalk(v2) {
    var children3 = v2.children, siblings = v2.parent.children, w = v2.i ? siblings[v2.i - 1] : null;
    if (children3) {
      executeShifts(v2);
...
function hue2(a4, b) {
  var d = b - a4;
  return d ? linear4(a4, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant_default11(isNaN(a4) ? b : a4);
}
function gamma2(y4) {
  return (y4 = +y4) === 1 ? nogamma2 : function(a4, b) {
    return b - a4 ? exponential2(a4, b, y4) : constant_default11(isNaN(a4) ? b : a4);
  };
}
function nogamma2(a4, b) {
  var d = b - a4;
  return d ? linear4(a4, d) : constant_default11(isNaN(a4) ? b : a4);
}
...
var rgb_default2 = function rgbGamma2(y4) {
  ...
  function rgb3(start3, end) {
    var r = color3((start3 = rgb(start3)).r, (end = rgb(end)).r), g = color3(start3.g, end.g), b = color3(start3.b, end.b), opacity = nogamma2(start3.opacity, end.opacity);
    return function(t) {
      start3.r = r(t);
      start3.g = g(t);
      start3.b = b(t);
...
function numberArray_default2(a4, b) {
  if (!b)
    b = [];
  var n = a4 ? Math.min(b.length, a4.length) : 0, c6 = b.slice(), i;
  return function(t) {
...
function array_default3(a4, b) {
  return (isNumberArray2(b) ? numberArray_default2 : genericArray2)(a4, b);
}
function genericArray2(a4, b) {
  var nb = b ? b.length : 0, na = a4 ? Math.min(nb, a4.length) : 0, x4 = new Array(na), c6 = new Array(nb), i;
  for (i = 0; i < na; ++i)
    x4[i] = value_default2(a4[i], b[i]);
  for (; i < nb; ++i)
    c6[i] = b[i];
  return function(t) {
    for (i = 0; i < na; ++i)
...
function object_default2(a4, b) {
  ...
  for (k2 in b) {
    if (k2 in a4) {
      i[k2] = value_default2(a4[k2], b[k2]);
    } else {
      c6[k2] = b[k2];
    }
  }
...
function string_default2(a4, b) {
  var bi = reA2.lastIndex = reB2.lastIndex = 0, am, bm, bs, i = -1, s2 = [], q = [];
  a4 = a4 + "", b = b + "";
  while ((am = reA2.exec(a4)) && (bm = reB2.exec(b))) {
    if ((bs = bm.index) > bi) {
      bs = b.slice(bi, bs);
      if (s2[i])
        s2[i] += bs;
  ...
  return s2.length < 2 ? q[0] ? one2(q[0].x) : zero4(b) : (b = q.length, function(t) {
    for (var i2 = 0, o; i2 < b; ++i2)
      s2[(o = q[i2]).i] = o.x(t);
    return s2.join("");
  });
...
function value_default2(a4, b) {
  var t = typeof b, c6;
  return b == null || t === "boolean" ? constant_default11(b) : (t === "number" ? number_default2 : t === "string" ? (c6 = color(b)) ? (b = c6, rgb_default2) : string_default2 : b instanceof color ? rgb_default2 : b instanceof Date ? date_default2 : isNumberArray2(b) ? numberArray_default2 : Array.isArray(b) ? genericArray2 : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default2 : number_default2)(a4, b);
}

// ../../node_modules/.pnpm/d3-interpolate@3.0.1/node_modules/d3-interpolate/src/discrete.js
function discrete_default2(range5) {
  var n = range5.length;
  return function(t) {
...
function decompose_default2(a4, b, c6, d, e, f) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a4 * a4 + b * b))
    a4 /= scaleX, b /= scaleX;
  if (skewX = a4 * c6 + b * d)
  ...
  return {
    translateX: e,
    translateY: f,
    rotate: Math.atan2(b, a4) * degrees5,
...
function parseCss2(value) {
  const m3 = new (typeof DOMMatrix === "function" ? DOMMatrix : WebKitCSSMatrix)(value + "");
  return m3.isIdentity ? identity4 : decompose_default2(m3.a, m3.b, m3.c, m3.d, m3.e, m3.f);
}
...
function interpolateTransform2(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a4, b, s2, q) {
    if (a4 !== b) {
      if (a4 - b > 180)
        ...
        a4 += 360;
      q.push({ i: s2.push(pop(s2) + "rotate(", null, degParen) - 2, x: number_default2(a4, b) });
    } else if (b) {
      s2.push(pop(s2) + "rotate(" + b + degParen);
    }
  }
  function skewX(a4, b, s2, q) {
    if (a4 !== b) {
      q.push({ i: s2.push(pop(s2) + "skewX(", null, degParen) - 2, x: number_default2(a4, b) });
    } else if (b) {
      s2.push(pop(s2) + "skewX(" + b + degParen);
    }
  }
...
var zoom_default2 = function zoomRho2(rho, rho2, rho4) {
  function zoom(p02, p1) {
    ...
    if (d2 < epsilon23) {
      ...
      S = (r1 - r0) / rho;
      i = function(t) {
        var s2 = t * S, coshr0 = cosh2(r0), u4 = w0 / (rho2 * d1) * (coshr0 * tanh2(rho * s2 + r0) - sinh2(r0));
        return [
          ux0 + u4 * dx,
          uy0 + u4 * dy,
...
function hsl4(hue3) {
  return function(start3, end) {
    var h = hue3((start3 = hsl(start3)).h, (end = hsl(end)).h), s2 = nogamma2(start3.s, end.s), l = nogamma2(start3.l, end.l), opacity = nogamma2(start3.opacity, end.opacity);
    return function(t) {
      start3.h = h(t);
      start3.s = s2(t);
      start3.l = l(t);
...
function lab4(start3, end) {
  var l = nogamma2((start3 = lab(start3)).l, (end = lab(end)).l), a4 = nogamma2(start3.a, end.a), b = nogamma2(start3.b, end.b), opacity = nogamma2(start3.opacity, end.opacity);
  return function(t) {
    start3.l = l(t);
    start3.a = a4(t);
    start3.b = b(t);
...
function hcl4(hue3) {
  return function(start3, end) {
    var h = hue3((start3 = hcl(start3)).h, (end = hcl(end)).h), c6 = nogamma2(start3.c, end.c), l = nogamma2(start3.l, end.l), opacity = nogamma2(start3.opacity, end.opacity);
    return function(t) {
      start3.h = h(t);
      start3.c = c6(t);
      start3.l = l(t);
...
function cubehelix4(hue3) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix5(start3, end) {
      var h = hue3((start3 = cubehelix(start3)).h, (end = cubehelix(end)).h), s2 = nogamma2(start3.s, end.s), l = nogamma2(start3.l, end.l), opacity = nogamma2(start3.opacity, end.opacity);
      return function(t) {
        start3.h = h(t);
        start3.s = s2(t);
        start3.l = l(Math.pow(t, y4));
...
function piecewise2(interpolate, values) {
  if (values === void 0)
    values = interpolate, interpolate = value_default2;
  var i = 0, n = values.length - 1, v2 = values[0], I = new Array(n < 0 ? 0 : n);
  while (i < n)
    I[i] = interpolate(v2, v2 = values[++i]);
  return function(t) {
...
Path3.prototype = path2.prototype = {
  ...
  arcTo: function(x12, y12, x22, y22, r) {
    ...
    if (this._x1 === null) {
      ...
      var x20 = x22 - x06, y20 = y22 - y06, l21_2 = x21 * x21 + y21 * y21, l20_2 = x20 * x20 + y20 * y20, l21 = Math.sqrt(l21_2), l01 = Math.sqrt(l01_2), l = r * Math.tan((pi6 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01))) / 2), t01 = l / l01, t21 = l / l21;
  ...
  arc: function(x4, y4, r, a0, a1, ccw) {
    ...
    if (da2 > tauEpsilon2) {
      ...
      this._ += "A" + r + "," + r + ",0," + +(da2 >= pi6) + "," + cw + "," + (this._x1 = x4 + r * Math.cos(a1)) + "," + (this._y1 = y4 + r * Math.sin(a1));
    }
  },
  rect: function(x4, y4, w, h) {
    this._ += "M" + (this._x0 = this._x1 = +x4) + "," + (this._y0 = this._y1 = +y4) + "h" + +w + "v" + +h + "h" + -w + "Z";
...
function quad_default2(node, x06, y06, x12, y12) {
  this.node = node;
  this.x0 = x06;
  this.y0 = y06;
  this.x1 = x12;
...
function find_default3(x4, y4, radius) {
  var data, x06 = this._x0, y06 = this._y0, x12, y12, x22, y22, x32 = this._x1, y32 = this._y1, quads = [], node = this._root, q, i;
  if (node)
    quads.push(new quad_default2(node, x06, y06, x32, y32));
  if (radius == null)
    radius = Infinity;
  else {
    x06 = x4 - radius, y06 = y4 - radius;
  ...
  while (q = quads.pop()) {
    ...
    if (node.length) {
      ...
      quads.push(
        ...
        new quad_default2(node[2], x12, ym, xm, y22),
        new quad_default2(node[1], xm, y12, x22, ym),
        new quad_default2(node[0], x12, y12, xm, ym)
      );
      if (i = (y4 >= ym) << 1 | x4 >= xm) {
        q = quads[quads.length - 1];
        quads[quads.length - 1] = quads[quads.length - 1 - i];
...
function visit_default2(callback) {
  ...
  while (q = quads.pop()) {
    if (!callback(node = q.node, x06 = q.x0, y06 = q.y0, x12 = q.x1, y12 = q.y1) && node.length) {
      var xm = (x06 + x12) / 2, ym = (y06 + y12) / 2;
      if (child = node[3])
        quads.push(new quad_default2(child, xm, ym, x12, y12));
      if (child = node[2])
        quads.push(new quad_default2(child, x06, ym, xm, y12));
      if (child = node[1])
        quads.push(new quad_default2(child, xm, y06, x12, ym));
      if (child = node[0])
        quads.push(new quad_default2(child, x06, y06, xm, ym));
    }
  }
  return this;
}
...
function quadtree2(nodes, x4, y4) {
  var tree = new Quadtree2(x4 == null ? defaultX3 : x4, y4 == null ? defaultY3 : y4, NaN, NaN, NaN, NaN);
  return nodes == null ? tree : tree.addAll(nodes);
}
function Quadtree2(x4, y4, x06, y06, x12, y12) {
  this._x = x4;
  this._y = y4;
  this._x0 = x06;
  this._y0 = y06;
...
treeProto2.copy = function() {
  var copy3 = new Quadtree2(this._x, this._y, this._x0, this._y0, this._x1, this._y1), node = this._root, nodes, child;
  if (!node)
    return copy3;
  if (!node.length)
...
var binomial_default = function sourceRandomBinomial(source) {
  var G = geometric_default.source(source), B4 = beta_default.source(source);
  function randomBinomial(n, p) {
    ...
    return function() {
      ...
      while (nn * pp > 16 && nn * (1 - pp) > 16) {
        var i = Math.floor((nn + 1) * pp), y4 = B4(i, nn - i + 1)();
        if (y4 <= pp) {
          acc += i;
          nn -= i;
          pp = (pp - y4) / (1 - y4);
...
var poisson_default = function sourceRandomPoisson(source) {
  var G = gamma_default.source(source), B4 = binomial_default.source(source);
...
function ordinal() {
  var index4 = new InternMap(), domain = [], range5 = [], unknown = implicit;
  function scale2(d) {
    let i = index4.get(d);
    if (i === void 0) {
      if (unknown !== implicit)
...
function transformer2() {
  var domain = unit, range5 = unit, interpolate = value_default, transform2, untransform, unknown, clamp = identity5, piecewise3, output, input;
  function rescale() {
  ...
  function scale2(x4) {
    return x4 == null || isNaN(x4 = +x4) ? unknown : (output || (output = piecewise3(domain.map(transform2), range5, interpolate)))(transform2(clamp(x4)));
  }
  scale2.invert = function(y4) {
    return clamp(untransform((input || (input = piecewise3(range5, domain.map(transform2), number_default)))(y4)));
  };
  scale2.domain = function(_) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/formatDecimal.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/exponent.js
function exponent_default2(x4) {
  return x4 = formatDecimalParts2(Math.abs(x4)), x4 ? x4[1] : NaN;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/formatGroup.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/formatNumerals.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/formatSpecifier.js
var re2 = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/formatTrim.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/formatPrefixAuto.js
var prefixExponent2;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/formatRounded.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/formatTypes.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/identity.js
function identity_default5(x4) {
  return x4;
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/locale.js
var map6 = Array.prototype.map;
var prefixes2 = ["y", "z", "a", "f", "p", "n", "\xB5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function locale_default2(locale5) {
  var group3 = locale5.grouping === void 0 || locale5.thousands === void 0 ? identity_default5 : formatGroup_default2(map6.call(locale5.grouping, Number), locale5.thousands + ""), currencyPrefix = locale5.currency === void 0 ? "" : locale5.currency[0] + "", currencySuffix = locale5.currency === void 0 ? "" : locale5.currency[1] + "", decimal = locale5.decimal === void 0 ? "." : locale5.decimal + "", numerals = locale5.numerals === void 0 ? identity_default5 : formatNumerals_default2(map6.call(locale5.numerals, String)), percent = locale5.percent === void 0 ? "%" : locale5.percent + "", minus = locale5.minus === void 0 ? "\u2212" : locale5.minus + "", nan = locale5.nan === void 0 ? "NaN" : locale5.nan + "";
  function newFormat(specifier) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/defaultLocale.js
var locale2;
var format2;
var formatPrefix2;
defaultLocale2({
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/precisionFixed.js
function precisionFixed_default2(step) {
  return Math.max(0, -exponent_default2(Math.abs(step)));
}

// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/precisionPrefix.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-format@3.1.0/node_modules/d3-format/src/precisionRound.js
function precisionRound_default2(step, max6) {
  step = Math.abs(step), max6 = Math.abs(max6) - step;
  return Math.max(0, exponent_default2(max6) - exponent_default2(step)) + 1;
}

// ../../node_modules/.pnpm/d3-scale@4.0.2/node_modules/d3-scale/src/tickFormat.js
function tickFormat(start3, stop, count4, specifier) {
  var step = tickStep2(start3, stop, count4), precision;
...
function linearish(scale2) {
  ...
  scale2.ticks = function(count4) {
    var d = domain();
    return ticks2(d[0], d[d.length - 1], count4 == null ? 10 : count4);
  };
  ...
  scale2.nice = function(count4) {
    ...
    while (maxIter-- > 0) {
      step = tickIncrement2(start3, stop, count4);
      if (step === prestep) {
        d[i0] = start3;
        d[i1] = stop;
        return domain(d);
...
function loggish(transform2) {
  ...
  scale2.tickFormat = (count4, specifier) => {
    if (count4 == null)
      count4 = 10;
    if (specifier == null)
      specifier = base === 10 ? "s" : ",";
    ...
    if (count4 === Infinity)
      return specifier;
    const k2 = Math.max(1, base * count4 / scale2.ticks().length);
    return (d) => {
...
function transformPow(exponent3) {
  return function(x4) {
    return x4 < 0 ? -Math.pow(-x4, exponent3) : Math.pow(x4, exponent3);
  };
}
...
function powish(transform2) {
  var scale2 = transform2(identity5, identity5), exponent3 = 1;
  function rescale() {
    return exponent3 === 1 ? transform2(identity5, identity5) : exponent3 === 0.5 ? transform2(transformSqrt, transformSquare) : transform2(transformPow(exponent3), transformPow(1 / exponent3));
  }
...
function quantize() {
  ...
  function scale2(x4) {
    return x4 != null && x4 <= x4 ? range5[bisect_default2(domain, x4, 0, n)] : unknown;
  }
  function rescale() {
    var i = -1;
    domain = new Array(n);
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/interval.js
var t03 = new Date();
var t13 = new Date();
function newInterval(floori, offseti, count4, field) {
  ...
  interval3.range = function(start3, stop, step) {
    var range5 = [], previous;
    ...
    if (!(start3 < stop) || !(step > 0))
      return range5;
    do
      range5.push(previous = new Date(+start3)), offseti(start3, step), floori(start3);
  ...
  if (count4) {
    interval3.count = function(start3, end) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/millisecond.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/duration.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/second.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/minute.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/hour.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/day.js
var day = newInterval(
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/week.js
function weekday(i) {
  return newInterval(function(date2) {
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/month.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/year.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/utcMinute.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/utcHour.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/utcDay.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/utcWeek.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/utcMonth.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/utcYear.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time@3.0.0/node_modules/d3-time/src/ticks.js
function ticker(year3, month3, week, day3, hour3, minute3) {
  ...
  function ticks3(start3, stop, count4) {
    const reverse3 = stop < start3;
    if (reverse3)
      [start3, stop] = [stop, start3];
    const interval3 = count4 && typeof count4.range === "function" ? count4 : tickInterval(start3, stop, count4);
    const ticks4 = interval3 ? interval3.range(start3, +stop + 1) : [];
    return reverse3 ? ticks4.reverse() : ticks4;
  }
  function tickInterval(start3, stop, count4) {
    const target = Math.abs(stop - start3) / count4;
    const i = bisector2(([, , step2]) => step2).right(tickIntervals, target);
    if (i === tickIntervals.length)
      return year3.every(tickStep2(start3 / durationYear, stop / durationYear, count4));
    if (i === 0)
      return millisecond_default.every(Math.max(tickStep2(start3, stop, count4), 1));
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time-format@4.1.0/node_modules/d3-time-format/src/locale.js
...
function formatLocale(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      var string = [], i = -1, j = 0, n = specifier.length, c6, pad5, format3;
      if (!(date2 instanceof Date))
        date2 = new Date(+date2);
      while (++i < n) {
        if (specifier.charCodeAt(i) === 37) {
          string.push(specifier.slice(j, i));
          if ((pad5 = pads[c6 = specifier.charAt(++i)]) != null)
            c6 = specifier.charAt(++i);
          else
            pad5 = c6 === "e" ? " " : "0";
          if (format3 = formats2[c6])
            c6 = format3(date2, pad5);
          string.push(c6);
          j = i + 1;
        }
      }
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time-format@4.1.0/node_modules/d3-time-format/src/defaultLocale.js
var locale3;
var timeFormat;
var timeParse;
var utcFormat;
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time-format@4.1.0/node_modules/d3-time-format/src/isoFormat.js
...
// ../../node_modules/.pnpm/registry.npmmirror.com+d3-time-format@4.1.0/node_modules/d3-time-format/src/isoParse.js
...
function calendar(ticks3, tickInterval, year3, month3, week, day3, hour3, minute3, second3, format3) {
  var scale2 = continuous(), invert = scale2.invert, domain = scale2.domain;
  var formatMillisecond = format3(".%L"), formatSecond = format3(":%S"), formatMinute = format3("%I:%M"), formatHour = format3("%I %p"), formatDay = format3("%a %d"), formatWeek = format3("%b %d"), formatMonth = format3("%B"), formatYear5 = format3("%Y");
  function tickFormat2(date2) {
    return (second3(date2) < date2 ? formatMillisecond : minute3(date2) < date2 ? formatSecond : hour3(date2) < date2 ? formatMinute : day3(date2) < date2 ? formatHour : month3(date2) < date2 ? week(date2) < date2 ? formatDay : formatWeek : year3(date2) < date2 ? formatMonth : formatYear5)(date2);
  }
  scale2.invert = function(y4) {
  ...
  scale2.nice = function(interval3) {
    ...
    return interval3 ? domain(nice3(d, interval3)) : scale2;
  };
  scale2.copy = function() {
    return copy(scale2, calendar(ticks3, tickInterval, year3, month3, week, day3, hour3, minute3, second3, format3));
  };
  return scale2;
}
function time() {
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t05, t15, t23, k10, k21, interpolator = identity5, transform2, clamp = false, unknown;
  function scale2(x4) {
  ...
  scale2.domain = function(_) {
    return arguments.length ? ([x06, x12, x22] = _, t05 = transform2(x06 = +x06), t15 = transform2(x12 = +x12), t23 = transform2(x22 = +x22), k10 = t05 === t15 ? 0 : 0.5 / (t15 - t05), k21 = t15 === t23 ? 0 : 0.5 / (t23 - t15), s2 = t15 < t05 ? -1 : 1, scale2) : [x06, x12, x22];
  };
  scale2.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale2) : clamp;
  };
  ...
  return function(t) {
    transform2 = t, t05 = t(x06), t15 = t(x12), t23 = t(x22), k10 = t05 === t15 ? 0 : 0.5 / (t15 - t05), k21 = t15 === t23 ? 0 : 0.5 / (t23 - t15), s2 = t15 < t05 ? -1 : 1;
    return scale2;
  };
}
function diverging() {
...
function cornerTangents(x06, y06, x12, y12, r1, rc, cw) {
  var x01 = x06 - x12, y01 = y06 - y12, lo = (cw ? rc : -rc) / sqrt3(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x06 + ox, y11 = y06 + oy, x10 = x12 + ox, y10 = y12 + oy, x004 = (x11 + x10) / 2, y004 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r = r1 - rc, D4 = x11 * y10 - x10 * y11, d = (dy < 0 ? -1 : 1) * sqrt3(max5(0, r * r * d2 - D4 * D4)), cx0 = (D4 * dy - dx * d) / d2, cy0 = (-D4 * dx - dy * d) / d2, cx1 = (D4 * dy + dx * d) / d2, cy1 = (-D4 * dx + dy * d) / d2, dx0 = cx0 - x004, dy0 = cy0 - y004, dx1 = cx1 - x004, dy1 = cy1 - y004;
...
function arc_default() {
  var innerRadius = arcInnerRadius, outerRadius = arcOuterRadius, cornerRadius = constant_default13(0), padRadius = null, startAngle = arcStartAngle, endAngle = arcEndAngle, padAngle = arcPadAngle, context = null;
  function arc() {
    ...
    if (!(r1 > epsilon9))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon9 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min4(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t05, t15;
      if (rp > epsilon9) {
      ...
      if (rc > epsilon9) {
        ...
        if (da2 < pi7 && (oc = intersect(x01, y01, x004, y004, x11, y11, x10, y10))) {
  ...
  arc.centroid = function() {
    var r = (+innerRadius.apply(this, arguments) + +outerRadius.apply(this, arguments)) / 2, a4 = (+startAngle.apply(this, arguments) + +endAngle.apply(this, arguments)) / 2 - pi7 / 2;
...
function line_default2(x4, y4) {
  var defined = constant_default13(true), context = null, curve = linear_default, output = null;
...
function area_default5(x06, y06, y12) {
  var x12 = null, defined = constant_default13(true), context = null, curve = linear_default, output = null;
...
function pie_default() {
  var value = identity_default6, sortValues = descending_default, sort3 = null, startAngle = constant_default13(0), endAngle = constant_default13(tau8), padAngle = constant_default13(0);
  function pie(data) {
    var i, n = (data = array_default4(data)).length, j, k2, sum5 = 0, index4 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da2 = Math.min(tau8, Math.max(-tau8, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)), pa = p * (da2 < 0 ? -1 : 1), v2;
    for (i = 0; i < n; ++i) {
...
var circle_default3 = {
  draw(context, size) {
    const r = sqrt3(size / pi7);
    context.moveTo(r, 0);
    context.arc(0, 0, r, 0, tau8);
  }
};
...
var kr = sin3(pi7 / 10) / sin3(7 * pi7 / 10);
var kx = sin3(tau8 / 10) * kr;
var ky = -cos3(tau8 / 10) * kr;
var star_default = {
  draw(context, size) {
...
function insideOut_default(series) {
  var n = series.length, i, j, sums = series.map(sum4), order = appearance_default(series), top2 = 0, bottom2 = 0, tops = [], bottoms = [];
  for (i = 0; i < n; ++i) {
    j = order[i];
    if (top2 < bottom2) {
      top2 += sums[j];
...
function newInterval2(floori, offseti, count4, field) {
  ...
  if (count4) {
    interval3.count = function(start3, end) {
      ...
      return Math.floor(count4(t04, t14));
    };
    interval3.every = function(step) {
      step = Math.floor(step);
      return !isFinite(step) || !(step > 0) ? null : !(step > 1) ? interval3 : interval3.filter(field ? function(d) {
...
function ticker2(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start3, stop, count4) {
    ...
    const i = bisector2(([, , step2]) => step2).right(tickIntervals, target);
    if (i === tickIntervals.length)
      return year3.every(tickStep2(start3 / durationYear2, stop / durationYear2, count4));
    if (i === 0)
      return millisecond_default2.every(Math.max(tickStep2(start3, stop, count4), 1));
    const [t, step] = tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i];
    return t.every(step);
  }
  return [ticks3, tickInterval];
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      ...
      while (++i < n) {
        if (specifier.charCodeAt(i) === 37) {
          string.push(specifier.slice(j, i));
          if ((pad5 = pads2[c6 = specifier.charAt(++i)]) != null)
            c6 = specifier.charAt(++i);
          else
            pad5 = c6 === "e" ? " " : "0";
          if (format3 = formats2[c6])
...
function formatUTCWeekNumberSunday2(d, p) {
  return pad4(utcSunday.count(utcYear_default(d) - 1, d), p, 2);
}
function UTCdISO2(d) {
  var day3 = d.getUTCDay();
  return day3 >= 4 || day3 === 0 ? utcThursday(d) : utcThursday.ceil(d);
...
function formatUTCWeekNumberISO2(d, p) {
  d = UTCdISO2(d);
  return pad4(utcThursday.count(utcYear_default(d), d) + (utcYear_default(d).getUTCDay() === 4), p, 2);
}
function formatUTCWeekdayNumberSunday2(d) {
  return d.getUTCDay();
}
function formatUTCWeekNumberMonday2(d, p) {
  return pad4(utcMonday.count(utcYear_default(d) - 1, d), p, 2);
}
...
function nap2() {
  var t05, t15 = taskHead2, t23, time2 = Infinity;
  while (t15) {
    if (t15._call) {
      if (time2 > t15._time)
        time2 = t15._time;
...
var emptyOn2 = dispatch_default("start", "end", "cancel", "interrupt");
var emptyTween2 = [];
var CREATED2 = 0;
var SCHEDULED2 = 1;
var STARTING2 = 2;
...
var ENDING2 = 5;
var ENDED2 = 6;
function schedule_default2(node, name, id3, index4, group3, timing) {
  var schedules = node.__transition;
  if (!schedules)
    node.__transition = {};
  else if (id3 in schedules)
...
function tweenRemove2(id3, name) {
  var tween0, tween1;
  return function() {
    var schedule = set5(this, id3), tween = schedule.tween;
    if (tween !== tween0) {
      tween1 = tween0 = tween;
      for (var i = 0, n = tween1.length; i < n; ++i) {
        if (tween1[i].name === name) {
...
function interpolate_default3(a4, b) {
  var c6;
  return (typeof b === "number" ? number_default : b instanceof color ? rgb_default : (c6 = color(b)) ? (b = c6, rgb_default) : string_default)(a4, b);
}
...
function attr_default4(name, value) {
  var fullname = namespace_default2(name), i = fullname === "transform" ? interpolateTransformSvg : interpolate_default3;
...
function durationFunction2(id3, value) {
  return function() {
    set5(this, id3).duration = +value.apply(this, arguments);
  };
}
function durationConstant2(id3, value) {
  return value = +value, function() {
    set5(this, id3).duration = value;
  };
}
...
function onFunction2(id3, name, listener) {
  var on0, on1, sit = start2(name) ? init2 : set5;
  return function() {
    var schedule = sit(this, id3), on = schedule.on;
    if (on !== on0)
      (on1 = (on0 = on).copy()).on(name, listener);
...
function selectAll_default6(select) {
  ...
  for (var groups3 = this._groups, m3 = groups3.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group3 = groups3[j], n = group3.length, node, i = 0; i < n; ++i) {
      if (node = group3[i]) {
        for (var children3 = select.call(node, node.__data__, i, group3), child, inherit3 = get4(node, id3), k2 = 0, l = children3.length; k2 < l; ++k2) {
          if (child = children3[k2]) {
            schedule_default2(child, name, id3, k2, children3, inherit3);
          }
        }
        subgroups.push(children3);
        parents.push(node);
...
function styleMaybeRemove2(id3, name) {
  var on0, on1, listener0, key = "style." + name, event = "end." + key, remove3;
  return function() {
    var schedule = set5(this, id3), on = schedule.on, listener = schedule.value[key] == null ? remove3 || (remove3 = styleRemove4(name)) : void 0;
    if (on !== on0 || listener0 !== listener)
      (on1 = (on0 = on).copy()).on(event, listener0 = listener);
    schedule.on = on1;
  };
  ...
  for (var groups3 = this._groups, m3 = groups3.length, j = 0; j < m3; ++j) {
    for (var group3 = groups3[j], n = group3.length, node, i = 0; i < n; ++i) {
      if (node = group3[i]) {
        ...
        schedule_default2(node, name, id1, i, group3, {
          time: inherit3.time + inherit3.delay + inherit3.duration,
          delay: 0,
          duration: inherit3.duration,
          ease: inherit3.ease
...
function end_default2() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    that.each(function() {
      var schedule = set5(this, id3), on = schedule.on;
      if (on !== on0) {
        on1 = (on0 = on).copy();
        on1._.cancel.push(cancel);
        on1._.interrupt.push(cancel);
...
function transition_default4(name) {
  ...
  if (name instanceof Transition2) {
    ...
    id3 = newId2(), (timing = defaultTiming2).time = now(), name = name == null ? null : name + "";
  }
  for (var groups3 = this._groups, m3 = groups3.length, j = 0; j < m3; ++j) {
    for (var group3 = groups3[j], n = group3.length, node, i = 0; i < n; ++i) {
      if (node = group3[i]) {
        schedule_default2(node, name, id3, i, group3, timing || inherit2(node, id3));
      }
    }
  }
...
function zoom_default3() {
  ...
  zoom.scaleTo = function(selection3, k2, p, event) {
    zoom.transform(selection3, function() {
      var e = extent3.apply(this, arguments), t05 = this.__zoom, p02 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t05.invert(p02), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
      return constrain(translate(scale2(t05, k1), p02, p1), e, translateExtent);
    }, p, event);
  };
  zoom.translateBy = function(selection3, x4, y4, event) {
    zoom.transform(selection3, function() {
  ...
  zoom.translateTo = function(selection3, x4, y4, p, event) {
    zoom.transform(selection3, function() {
  ...
  function schedule(transition3, transform2, point6, event) {
  ...
  function dblclicked(event, ...args) {
    if (!filter5.apply(this, arguments))
      return;
    var t05 = this.__zoom, p02 = pointer_default(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t05.invert(p02), k1 = t05.k * (event.shiftKey ? 0.5 : 2), t15 = constrain(translate(scale2(t05, k1), p02, p1), extent3.apply(this, args), translateExtent);
    noevent_default4(event);
    if (duration > 0)
      select_default2(this).transition().duration(duration).call(schedule, t15, p02, event);
    else
      select_default2(this).call(zoom.transform, t15, p02, event);
  }
  ...
  zoom.filter = function(_) {
    return arguments.length ? (filter5 = typeof _ === "function" ? _ : constant_default14(!!_), zoom) : filter5;
  };
...
export {
  ...
  cumsum,
  basis_default3 as curveBasis,
  basisClosed_default3 as curveBasisClosed,
  ...
  array_default3 as interpolateArray,
  ...
  cubehelix_default3 as interpolateCubehelixDefault,
  ...
  path_default4 as path,
  permute,
  pie_default as pie,
  piecewise2 as piecewise,
  pointRadial_default as pointRadial,
  pointer_default2 as pointer,
  pointers_default2 as pointers,
