...
// ../../node_modules/.pnpm/@floating-ui+core@0.6.2/node_modules/@floating-ui/core/dist/floating-ui.core.esm.development.js
...
// ../../node_modules/.pnpm/@floating-ui+dom@0.4.5/node_modules/@floating-ui/dom/dist/floating-ui.dom.esm.development.js
...
// ../../node_modules/.pnpm/vue-devui@1.0.0-beta.220808_vue@3.2.41/node_modules/vue-devui/splitter/index.es.js
var fixedOverlayProps = {
  modelValue: {
    type: Boolean,
    default: false
  },
...
function useOverlay(props, emit) {
  ...
  const updatePosition = async () => {
    ...
    const { x, y, placement, middlewareData } = await computePosition2(hostEl, overlayEl, {
      strategy: "fixed",
      middleware
    });
    let applyX = x;
...
var FlexibleOverlay = defineComponent({
...
var POPPER_TRIGGER_TOKEN = Symbol("popper-trigger");
var isObject = (val) => val !== null && typeof val === "object";
var ns = useNamespace("popper-trigger");
...
var camelize = (name) => name.substring(1).replace(/^\S/, (s) => s.toLocaleLowerCase());
...
var SplitterStore = class {
  ...
  resize(paneState, moveSize) {
    ...
    if (this.isPercent(pane.component.props.size)) {
      size2 = newSize / splitterSize * 100 + "%";
    } else {
      size2 = newSize + "px";
    }
    pane.component.props.size = size2;
    pane.component.emit("sizeChange", size2);
  }
  ...
  toPixels(size2) {
    let result = parseFloat(size2);
    if (this.isPercent(size2)) {
...
var SplitterPane = defineComponent({
  ...
  setup(props, {
    ...
    watch([() => props.size, domRef], ([size2, ele]) => {
      if (size2 && ele) {
        setSizeStyle(size2, ele);
      }
    }, {
      immediate: true
    });
...
// dep:vue-devui_splitter
var vue_devui_splitter_default = index;
export {
  Splitter,
  vue_devui_splitter_default as default,
  splitterProps
};
/**
 * @license
 ...
 */
//# sourceMappingURL=vue-devui_splitter.js.map
