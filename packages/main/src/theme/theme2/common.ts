...
const ThemeVars = {
  ...
  '--layout-sider-label-color': StaticVars['--light-white1'],
  '--layout-sider-active-label-color': StaticVars['--n-red6'],
  ...
  // 模态头部
  '--layout-header-menu-border-top-color': StaticVars['--n-red6'],
  ...
  // primary配色
  '--primary-color': StaticVars['--n-red3'],
  '--primary-color-hover': StaticVars['--n-red2'],
  '--primary-color-pressed': StaticVars['--n-red1'],
  '--primary-color-suppl': StaticVars['--n-red2'],

  // info配色
  '--info-color': StaticVars['--n-red3'],
  '--info-color-hover': StaticVars['--n-red2'],
  '--info-color-pressed': StaticVars['--n-red1'],
  '--info-color-suppl': StaticVars['--n-red2'],
  ...
  // native 原有颜色修改
  '--n-menu-item-color-active': StaticVars['--n-red3'],
  '--n-menu-item-text-color-active': StaticVars['--light-white1'],
  //标题颜色
  '--header-icon-bg': StaticVars['--n-red4'],
