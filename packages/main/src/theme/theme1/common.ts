...
const ThemeVars = {
  ...
  // 框架侧栏
  '--layout-sider': StaticVars['--light-white1'],
  '--layout-sider-label-color': StaticVars['--gray1'],
  '--layout-sider-active-label-color': StaticVars['--n-blue6'],
  '--layout-sider-active-label-bgcolor': StaticVars['--light-white1'],
  '--layout-sider-active-label-shadowcolor': StaticVars['--light-white1'],
  '--layout-sider-active-menu-margin-left': StaticVars['--menu-margin-left'],
  '--layout-sider-hover-label-color': StaticVars['--n-blue6'],
  // 模态头部
  '--layout-header-menu-border-top-color': StaticVars['--n-blue6'],
  '--layout-header-menu-border-bottom-color': StaticVars['--light-white1'],
  ...
  // primary配色
  '--primary-color': StaticVars['--n-green6'],
  '--primary-color-hover': StaticVars['--n-green2'],
  '--primary-color-pressed': StaticVars['--n-green3'],
  '--primary-color-suppl': StaticVars['--n-green6'],
  ...
  // success配色
  '--success-color': StaticVars['--n-green6'],
  ...
  // native 原有颜色修改
  '--n-menu-item-color-active': StaticVars['--n-blue6'],
  '--n-menu-item-text-color-active': StaticVars['--light-white1'],

  //标题颜色
  '--header-icon-bg': StaticVars['--light-white1'],
