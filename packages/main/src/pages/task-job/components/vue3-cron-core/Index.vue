<template>
  <div class="v3c" ref="v3c">
    <ul class="v3c-tab">
      <li class="v3c-tab-item" :class="{ 'v3c-active': tabActive == 1 }" @click="onHandleTab(1)">{{
      state.text.Seconds.name }}</li>
      <li class="v3c-tab-item" :class="{ 'v3c-active': tabActive == 2 }" @click="onHandleTab(2)">{{
      state.text.Minutes.name }}</li>
      <li class="v3c-tab-item" :class="{ 'v3c-active': tabActive == 3 }" @click="onHandleTab(3)">{{
      state.text.Hours.name }}</li>
      <li class="v3c-tab-item" :class="{ 'v3c-active': tabActive == 4 }" @click="onHandleTab(4)">{{ state.text.Day.name
      }}</li>
      <li class="v3c-tab-item" :class="{ 'v3c-active': tabActive == 5 }" @click="onHandleTab(5)">{{
      state.text.Month.name }}</li>
      <li class="v3c-tab-item" :class="{ 'v3c-active': tabActive == 6 }" @click="onHandleTab(6)">{{ state.text.Year.name
      }}</li>
    ...
    <div class="v3c-content" v-show="tabActive == 1">
      ...
      <div class="mt-20">
        ...
        <n-select style="max-width: 350px;" multiple v-model:value="state.second.specificSpecific" :options="secOptions"
          :to="v3c && v3c.$el">
        </n-select>
      </div>
      <!-- 具体秒数 -->
    ...
    <div class="v3c-content" v-show="tabActive == 2">
      ...
      <div class="mt-20">
        ...
        <n-select multiple style="max-width: 350px;" :options="secOptions"
    ...
    <div class="v3c-content" v-show="tabActive == 3">
      ...
      <div class="mt-20">
        ...
        <n-select style="max-width: 350px;" multiple :options="hourOptions" v-model:value="state.hour.specificSpecific">
        </n-select>
      </div>
      <!-- 具体秒数 -->
      <div class="mt-20">
    ...
    <div class="v3c-content" v-show="tabActive == 4">
      ...
      <div class="mt-20">
        ...
        <n-select style="max-width: 350px;" multiple v-model:value="state.week.specificSpecific1"
          :options="weekOptions">
        </n-select>
      </div>
      <!-- 5 -->
      <div class="mt-20">
        ...
        <n-select style="max-width: 350px;" multiple v-model:value="state.week.specificSpecific" :options="dayOptions">
        </n-select>
      </div>
      <!-- 6 -->
      <div class="mt-20">
      ...
      <div class="mt-20">
        ...
        <n-select v-model:value="state.day.cronLastSpecificDomDay" style="max-width: 350px;" :options="weekOptions">
        </n-select>
      ...
      <div class="mt-20">
        ...
        <n-select v-model:value="state.week.cronNthDayDay" style="max-width: 350px;" :options="weekOptions">
        </n-select>
      </div>
    </div>
    <!-- 月 -->
    <div class="v3c-content" v-show="tabActive == 5">
      ...
      <div class="mt-20">
        ...
        <n-select multiple v-model:value="state.month.specificSpecific" style="max-width: 350px;" :options="monOptions">
        </n-select>
      </div>
      <!-- 4 -->
      <div class="mt-20">
    ...
    <div class="v3c-content" v-show="tabActive == 6">
      ...
      <!-- <div class="mt-20">
        <label for="year3">
          ...
          <n-select multiple v-model="state.year.specificSpecific">
      ...
      <div class="mt-20">
        <label for="year3">
          ...
          <input type="number" v-model="state.year.rangeStart" :min="currYear" :max="currYear + 10" />
          {{ state.text.Year.cycle[1] }}
          <input type="number" v-model="state.year.rangeEnd" :min="currYear" :max="currYear + 10" />
        </label>
      </div>
    </div>
    <!-- 结果 -->
...
export default defineComponent({
  ...
  setup(props, { emit }) {
      ...
      weeksText: computed(() => {
        ...
        switch (cronEvery.toString()) {
          ...
          case "2":
            ...
            break;
          case "4":
            state.week.specificSpecific1.map((val) => {
              weeks += val + ",";
            });
    ...
    const monOptions = ref([])
    for (let i = 0; i < 60; i++) {
      secOptions.value.push({
        label: i,
        value: i
      })
      if (i < 24) {
      ...
      if (i < 7) {
        weekOptions.value.push({
          label: state.text.Week[i],
          value: ['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT'][i]
        })
      }
      if (i < 32 && i > 0) {
...
.btn-ok {
  ...
  -webkit-user-n-select: none;
  -moz-user-n-select: none;
  -ms-user-n-select: none;
  user-n-select: none;
