<template>
  ...
  >
    <template v-slot:DSplitterPane>
      <d-splitter-pane class="splitter-bpmn-view" size="300px" minSize="300px" @sizeChange="sizeChange">
              ...
              if (us) {
                return [
                  <NButton
                    ...
                    onClick={() => {
                      ...
                      context.emit('callback', false, row.id, row.dutyName, row.dutyCode, row)
                    }}
                  >{{
                    default: () => '已选择'
                  }}</NButton>
                ...
                return [
                  <NButton
                    ...
                    size="small"
                    onClick={() => {
                      context.emit('callback', true, row.id, row.dutyName, row.dutyCode, row)
