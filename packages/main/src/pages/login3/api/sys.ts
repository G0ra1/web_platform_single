...
export default [
    {
        ...
        menus: [
            ...
            },
            {
                ...
                key: 'dict',
                type: 1,
                url: '/web-old/html/mdm/system-dict.html'
            },
            {
                label: '树形字典表',
                key: 'dict-tree',
                type: 1,
                url: '/web-old/html/mdm/category-dict.html'
            },
            {
                label: '消息模板',
                key: 'template-news',
                type: 1,
                url: '/web-main/pages/template-news.html'
            }
        ],
        pages: {
            ...
            'dict': '/web-old/html/mdm/system-dict.html',
            'dict-tree': '/web-old/html/mdm/category-dict.html',
            'template-news': '/web-main/pages/template-news.html'
        },
        formListUrl: {
