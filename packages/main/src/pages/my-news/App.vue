...
import Details from '../all-news/details.vue'
import { NLayout, NLayoutHeader, NLayoutContent, NSpace, NInput, NSelect, NInputGroup, useDialog, NButton, useMessage } from 'naive-ui'
...
<template>
    <n-layout has-sider class="nw-layout-full">
        ...
        <n-layout class="nw-layout-full">
            ...
            <!-- 内容区列表 start -->
            <n-layout-content>
                <vxe-grid v-bind="bind" v-on="gridEvents" @checkbox-change="checkChange" @checkbox-all="checkChange" ref="gridRef">
                </vxe-grid>
            </n-layout-content>
            <!-- 内容区列表 end -->
        </n-layout>
