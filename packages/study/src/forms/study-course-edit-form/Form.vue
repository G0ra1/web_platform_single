...
import ChooseCourseware from "../study-course-add-form/chooseCourseware.vue";
import ChooseLearningMaterials from "../study-course-add-form/chooseLearningMaterials.vue";
