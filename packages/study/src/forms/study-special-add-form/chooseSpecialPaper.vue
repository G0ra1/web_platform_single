        ...
        <n-grid-item span="6" style="height: 800px;" v-if="showSide">
            <div class="sider">
                ...
                <n-spin :show="leftSpinShow" style="padding-top: 6px">
                    ...
                    >
                        <vxe-table-column field="dictItemName" title="试题分类"></vxe-table-column>
            ...
            <n-grid-item :span="showSide ? 18 : 24" style="height: 800px;">
                 <n-spin :show="spinShow" >
                    ...
                    >
                        ...
                        <vxe-column field="specialPaperName" title="试卷名称" ></vxe-column>
                        <vxe-column field="specialPaperTotalScore" title="试卷总分" ></vxe-column>
                        <vxe-column field="specialExamTime" title="试卷时长" ></vxe-column>
                    ...
                    >
                        <vxe-column field="practisePaperName" title="试卷名称" ></vxe-column>
                        <vxe-column field="practisePaperTotalScore" title="试卷总分" ></vxe-column>
                        <vxe-column field="specialExamTime" title="试卷时长" ></vxe-column>
...
import { paperQuerys,dictItemLists  } from './api'
...
export default defineComponent({
  ...
  setup (props,context) {
    ...
    const sonFn = (e=[]) => {
      ...
      if(props.multiple){
        course.alreadyTopicList=e.map((d)=>
            {
                d.id = d.practisePaperId 
                return d
            }
        )
      } else {
        course.alreadyTopicList[0] = {...e,id:e.specialPaperId}
      }
     
      leftSpinShow.value = true
        dictItemLists('STUDY_PAPER_TYPE').then((res)=>{
    ...
    const  getTopic = (id)=>{
        spinShow.value = true
        paperQuerys({typeCode:id,paperType:'1'}).then((res)=>{
            course.topicList = res.map((d)=>{
                d.specialPaperId = d.id
                d.specialPaperName = d.paperName
                d.specialPaperTotalScore = d.paperTotalScore
                return d
            })
