            ...
            <n-grid-item :span="showSide ? 18 : 24" style="height: 800px;">
                 <n-spin :show="spinShow" >
                    ...
                    >
                        ...
                        <vxe-column field="practisePaperExamTime" title="试卷时长" ></vxe-column>
  ...
  setup (props,context) {
    ...
    const sonFn = (e=[]) => {
      ...
      if(props.multiple){
        ...
        course.alreadyTopicList[0] = {...e,id:e.practisePaperId}
      }
    ...
    const  getTopic = (id)=>{
        spinShow.value = true
        paperQuerys({typeCode:id,paperType:'0'}).then((res)=>{
            course.topicList = res.map((d)=>{
                d.practisePaperId = d.id
                d.practisePaperName = d.paperName
                d.practisePaperTotalScore = d.paperTotalScore
                d.practisePaperExamTime = d.specialExamTime
                return d
            })
