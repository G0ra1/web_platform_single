                    ...
                    >
                       <vxe-column field="databaseName" title="题库名称" ></vxe-column>
                        ...
                        <vxe-table-column field="" title="操作">
                            <vxe-button type="text"
                                @click="()=>{
                                    course.alreadyTopicList.splice(index, 1)
                                    $refs.blTable.loadData(course.alreadyTopicList)
...
import { studyExamDatabaseDefLists, } from '../question-bank/api'
...
export default defineComponent({
  ...
  setup (props,context) {
    ...
    const  getTopic = (id)=>{
        spinShow.value = true
        studyExamDatabaseDefLists({typeCode:id,}).then((res)=>{
            course.topicList = res
    ...
    const onPositiveClick =(row) =>{
        ...
        if(!props.multiple){
           ...
           spinShow.value = false
            ...
            console.log(course.alreadyTopicList,'course.alreadyTopicList')
