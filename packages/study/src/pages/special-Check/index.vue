        ...
        <template v-slot:search-form="{ searchFormData, searchFormData2 }">
          ...
          <n-form :model="searchFormData">
            <n-grid :cols="1" x-gap="12" style="width:90%;margin:0 auto">
              <n-gi>
                <n-form-item path="targetName" label="专题名称">
                  <n-input
  ...
  setup(props,context) {
    ...
    return {
      ...
      request: {
        ...
        params: { applyStatus : labelValue.value,targetType:1},
      ...
      columns: reactive([
        ...
        { field: "targetName", title: "专题名称", showHeaderOverflow: true,},
        { field: "applyMessage", title: "申请描述", showHeaderOverflow: true,},
