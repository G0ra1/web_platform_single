        ...
        <template v-slot:search-form="{ searchFormData, searchFormData2 }">
          <n-form :model="searchFormData">
             <n-grid :cols="2" x-gap="12">
              <n-grid-item>
                  <n-form-item label="字典项" path="dictItemName">
                    <n-input v-model:value="searchFormData.dictItemName" @keydown.enter.prevent />
                  </n-form-item>
              </n-grid-item>
               <n-grid-item>
                  <n-form-item label="字典编码" path="dictItemCode">
                    <n-input v-model:value="searchFormData.dictItemCode" @keydown.enter.prevent />
                  </n-form-item>
              </n-grid-item>
            </n-grid>
          </n-form>
