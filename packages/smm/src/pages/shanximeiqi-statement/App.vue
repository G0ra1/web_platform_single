      ...
      new VxeHelper.VxeGridPaging<any>(
        {
          columns: [
            ...
            { field: "alias", title: "别名", showHeaderOverflow: true },
            {
              field: "airDemand",
              title: "供气量（Nm3）",
              showHeaderOverflow: true,
            },
            {
              ...
              showHeaderOverflow: true,
              slots: {
                default: ({ row }) => [<span>{row.co2}</span>],
              },
            },
            { field: "h2s", title: "H2S(mg/m3)", showHeaderOverflow: true },
            {
              field: "waterDewPoint",
              title: "水露点(℃)",
              showHeaderOverflow: true,
        ...
        new RequestPaging("/smm/smmGasTemperamentReport/page", "post")
      );
    nextTick().then(() => {
      reset({
        //formNameCh: '测试'
