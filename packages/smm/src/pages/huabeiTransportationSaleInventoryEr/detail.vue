    ...
    <div style="height:700px">
      ...
      >
        <n-grid :cols="24" :x-gap="24" class="LFormNg">
          ...
          <!-- <n-form-item-gi :span="12" label="库存" path="stockName" class="LFormTable">
            <n-input
              placeholder="库存"
              disabled
              v-model:value="dataModel.stockName"
            />
          </n-form-item-gi> -->
          ...
          <n-form-item-gi :span="24" label="" path="code" class="LFormTable">
            <vxe-grid
              ...
              "
            >
              <template #zhan_default="{ row, column }">
                <span>{{row.stationName}}</span>
              </template>
              <template #chuyoudizhi_default="{ row, column }">
                <span>{{row.oilStorageName}}</span>
              </template>
...
export default {
  ...
  setup(props, context){
    ...
    const smmSxGasDailyOutListOption = ref({
      ...
      border: true,
      data: dataModel.value.smmHboilHandelswareElStockDetailList,
      showFooter: true,
      toolbarConfig: null,
      ...
      columns: [
        {
          ...
          minWidth: 200,
          editRender: {},
          slots: { default: "zhan_default", },
        },
        {
          title: "储油地址",
          field: "oilStorageName",
          showOverflow: "title",
          minWidth: 200,
          editRender: {},
          slots: { default: "chuyoudizhi_default", },
        },
        {
          title: "安全库存",
          field: "safeStock",
    ...
    watch(() => dataModel.value.smmHboilHandelswareElStockDetailList, (d) => {
