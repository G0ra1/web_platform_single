        ...
        <n-layout class="nw-layout-full">
            ...
            <n-layout-header class="nw-layout-header">
                <n-space :size="5" style="padding: 0 5px">
                    <!--放功能按钮的地方-->
                    <NwFunctionPredefine code="smmHebooilProductFormAdd" :params="paramsArray" />
                </n-space>
                <n-space :size="5" style="padding: 0 5px">
                    <n-input-group>
                        <n-input :value="filterData.productCode || ''" @update:value="(d: string) => filterData.productCode = d"
                            placeholder="产品编码" :style="{ width: '150px' }" style="margin-right: 10px" />
                        <n-input :value="filterData.productName || ''" @update:value="(d: string) => filterData.productName = d"
                            placeholder="产品名称" :style="{ width: '150px' }" style="margin-right: 10px" />
