  ...
  <n-layout class="nw-layout-full">
    <n-layout-header class="nw-layout-header">
      ...
      <n-space :size="5" style="padding: 0 5px">
        ...
        <n-button title="重置" :style="{ height: '36px' }" type="warning" @click="reset()">
          <template #icon>
      ...
      new VxeHelper.VxeGridPaging<any>(
        {
          columns: [
            ...
            { field: "createUserParentDeptName", title: "填报部门", showHeaderOverflow: true },         
            {
              field: "createUserName",
              title: "填报人",
              showHeaderOverflow: true,
            },
            { field: "fillTime", title: "填报时间", showHeaderOverflow: true },
            { field: "explanation", title: "备注", showHeaderOverflow: true },
            {
        ...
        new RequestPaging("/smm/smmMoistureContent/page", "post")
      );
    nextTick().then(() => {
      reset({
        //formNameCh: '测试'
