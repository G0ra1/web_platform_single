      ...
      <n-space :size="5" style="padding: 0 5px;position:absolute;">
        ...
        <n-form ref="formRef" inline label-placement="left" label-align="right" :label-width="120" :model="SearchForm"
          ...
          <n-form-item label="客户名称" path="customName">
            <n-input placeholder="客户名称" v-model:value="customName" />
          </n-form-item>
          <n-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const gridOptions = reactive({
      ...
      loading: false,
      columns: [
        { field: 'customName', title: '客户名称', showHeaderOverflow: true, },
        { field: 'customCode', title: '客户编码', showHeaderOverflow: true, },
