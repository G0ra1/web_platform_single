        ...
        <n-grid x-gap="8" :cols="2">
          <n-grid-item>
            <n-form-item label="客户名称" path="customName">
              <n-input size="small" placeholder="请输入" v-model:value="model.customName" />
            </n-form-item>
          </n-grid-item>
          <!-- <n-grid-item>
            <n-form-item label="客户编码" path="customCode">
              <n-input size="small" placeholder="请输入" v-model:value="model.customCode" />
            </n-form-item>
          </n-grid-item> -->
          <n-grid-item>
