        ...
        <n-grid x-gap="8" :cols="2">
          <n-grid-item>
            <n-form-item label="场站/区域名称" path="stationName">
              <n-input size="small" placeholder="请输入" v-model:value="model.stationName" />
            </n-form-item>
          </n-grid-item>
          <!-- <n-grid-item>
            <n-form-item label="场站/区域编码" path="stationCode">
              <n-input size="small" placeholder="请输入" v-model:value="model.stationCode" />
            </n-form-item>
          </n-grid-item> -->
          <n-grid-item>
