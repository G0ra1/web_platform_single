...
import { NLayout, NLayoutHeader, NLayoutContent, NButton, NSpace, NInput, NSelect, NInputGroup } from 'naive-ui'
import { bind, gridRef, filterData, query, refresh, applyTypeList, reset, paramsArray } from "./App.ts"
    ...
    <n-layout class="nw-layout-full">
      ...
      <n-layout-header class="nw-layout-header">
        <n-space :size="5" style="padding: 0 5px">
          <!--放功能按钮的地方-->
          <NwFunctionPredefine code="askForm_add" :params="paramsArray" />
        </n-space>
        <n-space :size="5" style="padding: 0 5px">
          <n-input-group>
            ...
            <n-select v-model:value="filterData.applyType" :options="applyTypeList"
              @update:value="(d: string) => filterData.applyType = d" placeholder="请选择" :style="{ width: '150px' }">
            </n-select>
