    ...
    <n-layout-header class="nw-layout-header">
      ...
      <n-space :size="5" style="padding: 0 5px;position:absolute;">
        ...
        <n-form ref="formRef" inline label-placement="left" label-align="right" :label-width="120" :model="SearchForm"
          style="height: 30px;">
          <n-form-item label="物资名称" path="commodityItemName">
            <n-input placeholder="物资名称" v-model:value="commodityItemName" />
          </n-form-item>
          <n-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const gridOptions = reactive({
      ...
      loading: false,
      columns: [
        { field: 'commodityItemName', title: '物资名称', showHeaderOverflow: true, },
        { field: 'commodityItemUnit', title: '计量单位', showHeaderOverflow: true, },
        {
          field: 'createTime',
          title: '创建时间',
                ...
                <div>
                  ...
                  >
                    {{
                      ...
                      default: () => `是否删除物资${row.commodityItemName}？`
                    }}
