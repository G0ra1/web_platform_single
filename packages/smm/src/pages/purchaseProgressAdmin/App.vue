        ...
        },
        {
          ...
          slots: {
            default: ({ row }) => {
              return [
                <div>
                  <a onClick={() => showAction({ ...row }, 1)} style="color:#4098fc;cursor: pointer;display:inline-block;">{"修改基本信息"}</a>
                  <a onClick={() => showAction({ ...row }, 3)} style="color:#4098fc;cursor: pointer;display:inline-block;margin-left:15px">{"修改时间信息"}</a>
                  <NPopconfirm
