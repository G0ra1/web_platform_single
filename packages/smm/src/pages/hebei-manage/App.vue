      ...
      <n-space :size="5" style="padding: 0 5px;position:absolute;">
        ...
        <n-form ref="formRef" inline label-placement="left" label-align="right" :label-width="120" :model="SearchForm"
          ...
          <n-form-item label="来源名称" path="pgtCustomName">
            <n-input placeholder="来源名称" v-model:value="pgtCustomName" />
          </n-form-item>
          <n-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const gridOptions = reactive({
      ...
      loading: false,
      columns: [
        { field: 'pgtCustomName', title: '来源名称', showHeaderOverflow: true, },
        { field: 'pgtCustomCode', title: '来源编码', showHeaderOverflow: true, },
