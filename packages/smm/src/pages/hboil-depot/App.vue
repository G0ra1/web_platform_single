    ...
    <n-layout class="nw-layout-full">
      ...
      <n-layout-header class="nw-layout-header">
        ...
        <n-space :size="5" style="padding: 0 5px">
          <n-input-group>
            <!--   <n-input
              :value="filterData.dictitemCode || ''"
              @update:value="(d: string) => filterData.dictitemCode = d"
              placeholder="储油单位编码"
              :style="{ width: '150px' }"
              style="margin-right: 10px"
            />
            <n-input
              :value="filterData.dictitemName || ''"
              @update:value="(d: string) => filterData.dictitemName = d"
              placeholder="储油单位名称"
              :style="{ width: '150px' }"
              style="margin-right: 10px"
            />
            <n-input
              :value="filterData.explanation || ''"
              @update:value="(d: string) => filterData.explanation = d"
              placeholder="备注"
              :style="{ width: '150px' }"
              style="margin-right: 10px"
            />
