  ...
  setup() {
    ...
    const {
      ...
      columns: [
        ...
        { field: 'sumJingkouNumber', title: '总井数（口）', showHeaderOverflow: true, },
        { field: 'sumSpjJingkouGas', title: '井口产气量(nm3/d)', showHeaderOverflow: true, },
        { field: 'sumOutGasNumber', title: '集气站外输气量(nm3/d)', showHeaderOverflow: true, },
        { field: 'processCenterInGas', title: '处理中心进气量(nm3/d)', showHeaderOverflow: true, },
        { field: 'sumOutsourcingGasNumber', title: '外购气量(nm3/d)', showHeaderOverflow: true, },
        { field: 'bingranOutGas', title: '炳然代输气量(nm3/d)', showHeaderOverflow: true, },
        { field: 'sumCooperateGasNumber', title: '合作气量(nm3/d)', showHeaderOverflow: true, },

      ]
    }, new RequestPaging(
      '/smm/smmSxGasDaily/page',
      'post'
    )
    )
    nextTick().then(() => {
