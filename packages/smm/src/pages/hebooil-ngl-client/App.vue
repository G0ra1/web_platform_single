        ...
        <n-layout class="nw-layout-full">
            ...
            <n-layout-header class="nw-layout-header">
                <n-space :size="5" style="padding: 0 5px">
                    <!--放功能按钮的地方-->
                    <NwFunctionPredefine code="smmHebooilNglClientFormAdd" :params="paramsArray" />
                </n-space>
                <n-space :size="5" style="padding: 0 5px">
                    <n-input-group>
                        <n-input :value="filterData.projectCode || ''" @update:value="(d: string) => filterData.projectCode = d"
                            placeholder="项目编码" :style="{ width: '150px' }" style="margin-right: 10px" />
                        <n-input :value="filterData.projectName || ''" @update:value="(d: string) => filterData.projectName = d"
                            placeholder="项目名称" :style="{ width: '150px' }" style="margin-right: 10px" />
