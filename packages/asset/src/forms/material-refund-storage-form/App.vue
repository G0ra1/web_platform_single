        ...
        >
          <template #buttons>
            <DoubleList
              ...
              :value="dataModel.detailList.map((item) => item.deliveryDetailId)"
              :url="[
                '/asset/assetMaterialRefundDetail/lists',
                '/asset/assetMaterialRefundDetail/getByIds',
              ]"
