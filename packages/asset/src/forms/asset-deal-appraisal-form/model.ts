...
export default class AssetAppraisal {
    //物资明细子表
    assetDealAppraisalDetailList: Array<MyAssetDetail> = new Array();
...
class MyAssetDetail {
    ...
    //鉴定数量
    appraisalNum: number = 0;
    //未鉴定数量
    notAppraisalNum!: number;
    //已鉴定数量
    totalAppraisalNum: number = 0;
}
export {
    MyAssetDetail
}