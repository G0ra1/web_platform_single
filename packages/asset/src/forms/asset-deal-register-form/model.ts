...
export default class AssetDealRegister {
    //物资明细账子表
    assetDealRegisterDetailList: Array<MyAssetDetail> = new Array();
...
class MyAssetDetail {
    constructor(data?: any) {
        if (data) {
            ...
            this.assetsDetailId = data.assetsDetailId;
            this.id = "";
            this.dealDetailId = data.id;
        }
    }
    id!: string;
    assetsDetailId!: string;
    //登记数量
    registerNum: number = 0;
    //资产id
    assetsId!: string;
    //分类id
    classifyId!: string;
