...
import { getByAssetsId } from "./api/index";
const _data = ref<Array<AssetsDetailVo>>([]);
...
const columns = [
    ...
    //{ field: 'itemCode', title: '财务编码', showHeaderOverflow: true, minWidth: '140px', align: 'center', showOverflow: true },
