<template>
  <div class="my-form-box">
    ...
    <n-form :model="dataModel" :rules="rules" ref="formRef" label-placement="left" label-align="left" :label-width="90"
      ...
      <n-grid :cols="12" :x-gap="24">
        ...
        <n-form-item-gi :span="6" label="退库编号" path="code">
          <n-input placeholder="退库编号" v-model:value="dataModel.code" disabled />
        </n-form-item-gi>
        ...
        <n-form-item-gi :span="12" label="" path="">
          <h5 class="card-title">退库详情</h5>
        </n-form-item-gi>
        <n-form-item-gi :span="12" label="" path="">
          <div style="width: 100%">
            <span style="height: 24px; line-height: 24px">退库详情</span>
            <n-button style="
                height: 24px;
                width: 24px;
                line-height: 24px;
            ...
            <vxe-table ref="detailTable" show-overflow border :data="assetsList" :column-config="{ resizable: true }"
              ...
              <vxe-table-column field="itemCode" width="135" title="物资编号"></vxe-table-column>
              ...
              <vxe-column field="materialQuality" width="135" title="材质"></vxe-column>
              <vxe-column field="classifyName" width="135" title="质保等级"></vxe-column>
              <vxe-column field="unitName" width="135" title="单位"></vxe-column>
              <vxe-column field="acceptNumber" width="135" title="领用数量"></vxe-column>
              <vxe-column field="withdrawalNumber" width="135" title="退库数量" :edit-render="{}">
                <template #edit="{ row, column }">
                  <vxe-input v-model="row.withdrawalNumber" type="number">
                  </vxe-input>
                </template>
              </vxe-column>
  ...
  <assetsApplyPick ref="assetsPickRef" @update:callback="callbackSetItem" :applyUserId="dataModel.applyUserId">
  </assetsApplyPick>
...
import assetsApplyPick from "../../components/assetswithdrawalPick/index.vue";
