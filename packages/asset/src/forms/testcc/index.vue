        ...
        <n-space vertical>
            ...
            <div style="height: 90%; position: relative;">
                ...
                <vxe-table
                    ...
                    <vxe-column field="desclong" title="物资长描述"></vxe-column>
                    <vxe-column field="usableNumber" title="可用数量"></vxe-column> -->
                    <!-- <vxe-column field="acceptNumber" title="出库数量" :edit-render="{}">
                        <template #edit="{ row ,column}">
                            <vxe-input v-model="row.acceptNumber" @change="numChangeEvent({row, column })" type="number" placeholder="请输出库数量"></vxe-input>
                        </template>
                    </vxe-column> -->
                </vxe-table>
            </div>
