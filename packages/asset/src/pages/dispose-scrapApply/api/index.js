...
export function getUpTask(taskLevel) {
  return request({
    url: `/asset/scrapApply/getUpTask/${taskLevel}`,
    method: 'get',
  })
}
...
export function getChildTask(parentId) {
  return request({
    url: `/asset/scrapApply/getChildTask/${parentId}`,
    method: 'post',
  })
}
...
export function getTreeTask(level) {
  return request({
    url: `/asset/scrapApply/getTreeTask/${level}`,
    method: 'get',
  })
}
...
export function getscrapApply(id) {
  return request({
    url: `/asset/scrapApply/${id}`,
    method: "get",
  });
