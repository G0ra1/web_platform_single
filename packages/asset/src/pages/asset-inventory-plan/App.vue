    ...
    <n-layout class="nw-layout-full">
      ...
      <n-layout-header class="nw-layout-header">
        <n-space :size="5" style="padding: 0 5px">
          ...
          <NwFunctionPredefine
            code="assetInventoryPlanFormAdd"
            :params="paramsArray"
          />
        </n-space>
        <n-space :size="5" style="padding: 0 5px">
          <n-input-group>
            ...
            />
            <n-input
              :value="filterData.inventoryYear || ''"
              @update:value="(d: string) => filterData.inventoryYear = d"
              placeholder="盘点年度"
              :style="{ width: '150px' }"
              style="margin-right: 10px"
            />
            <!-- <n-input
              :value="filterData.applyTime || ''"
              @update:value="(d: string) => filterData.applyTime = d"
              placeholder="申请日期"
              :style="{ width: '150px' }"
              style="margin-right: 10px"
            /> -->
