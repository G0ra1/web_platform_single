...
export default defineComponent({
  ...
  setup() {
    ...
    const columns = reactive([
      ...
      { field: "qualityAssuranceLevel", title: "质保等级", showHeaderOverflow: true, showOverflow: true, },
      { field: "manufacturer", title: "生产厂商", showHeaderOverflow: true, showOverflow: true, },
      { field: "productionDate", title: "生产日期", showHeaderOverflow: true, showOverflow: true, },
      { field: "batchNumber", title: "批次/炉号", showHeaderOverflow: true, showOverflow: true, },
      { field: "factoryCode", title: "出厂编码", showHeaderOverflow: true, showOverflow: true, },
      { field: "serviceLife", title: "使用年限", showHeaderOverflow: true, showOverflow: true, },
      { field: "warehouseName", title: "仓库地点", showHeaderOverflow: true, showOverflow: true, },
      { field: "shelfName", title: "货架号", showHeaderOverflow: true, showOverflow: true, },
      { field: "reason", title: "备注", showHeaderOverflow: true, showOverflow: true, },
      { field: "status", title: "状态", showHeaderOverflow: true, showOverflow: true, },
