...
export function getUpTask(taskLevel) {
  return request({
    url: `/asset/materialChange/getUpTask/${taskLevel}`,
    method: 'get',
  })
}
...
export function getChildTask(parentId) {
  return request({
    url: `/asset/materialChange/getChildTask/${parentId}`,
    method: 'post',
  })
}
...
export function getTreeTask(level) {
  return request({
    url: `/asset/materialChange/getTreeTask/${level}`,
    method: 'get',
  })
}
...
export function getmaterialChange(id) {
  return request({
    url: `/asset/materialChange/${id}`,
    method: "get",
  });
