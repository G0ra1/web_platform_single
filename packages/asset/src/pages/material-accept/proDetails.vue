      ...
      <div class="manhour-details">
        ...
        <div class="manhour">
          ...
          <div>
            ...
            <span>领用申请部门</span><span style="width: auto">{{ dataModel.applyUserDeptName }}</span>
            <span>领用申请单位</span><span style="width: auto">{{ dataModel.applyUserOrgName }}</span>
          </div>
        </div>
        <div class="manhour">
          <h3>库存数据</h3>
        </div>
        <vxe-table ref="skuListTable" show-overflow :data="dataModel.materialAcceptAssetsList" :column-config="{ resizable: true }"
