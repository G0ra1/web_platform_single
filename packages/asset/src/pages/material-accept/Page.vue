...
export default defineComponent({
  ...
  setup() {
    ...
    const columns = reactive([
      ...
      {
        field: "code", title: "领用编号", showHeaderOverflow: true, showOverflow: true, slots: {
          default: ({ row }) => {
            return <span onClick={() => { showDetails(row) }} style="color:#1d7ced;cursor: pointer;">{row.code}</span>
          }
        }
      },
      { field: "applyUserName", title: "领用申请人", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserDeptName", title: "领用申请部门", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserOrgName", title: "领用申请单位", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyTime", title: "领用申请时间", showHeaderOverflow: true, showOverflow: true, },
      // { field: "applyTime", title: "退还状态", showHeaderOverflow: true, showOverflow: true, },
      {
