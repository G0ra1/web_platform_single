...
import { bind, gridRef, filterData, query, refresh, reset, paramsArray, initDialog, inventoryPlanId } from "./App"
        ...
        <n-layout class="nw-layout-full">
            ...
            <n-layout-header class="nw-layout-header">
                <n-space :size="5" style="padding: 0 5px">
                    <!--放功能按钮的地方-->
                    <NwFunctionPredefine code="assetInventoryTaskFormAdd" :params="paramsArray" />
                </n-space>
                <n-space :size="5" style="padding: 0 5px">
                    <n-input-group>
                        ...
                        <n-input :value="filterData.createUserName || ''" @update:value="(d: string) => filterData.applyTime = d"
