<template>
  ...
  padding: '10px',
      ...
      <nw-form-view ref="formRef" src="/html/forms/asset-management-applications-form.html" />
      <template #footer>
...
export default defineComponent({
  ...
  setup() {
    ...
    const columns = reactive([
      ...
      {
        field: "code", title: "申请单号", minWidth: 120, showHeaderOverflow: true, showOverflow: true, slots: {
          default: ({ row }) => {
            return <span onClick={() => { showDetails(row) }} style="color:#1d7ced;cursor: pointer;">{row.code}</span>
          }
        }
      },
      { field: "applyUserOrgName", title: "申请机构", minWidth: 120, showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserDeptName", title: "申请部门", minWidth: 120, showHeaderOverflow: true, showOverflow: true, },
      { field: "itemTypeName", title: "采购类型", minWidth: 120, showHeaderOverflow: true, showOverflow: true, },
      { field: "sumTotalNumber", title: "总数量", minWidth: 120, showHeaderOverflow: true, showOverflow: true, },
      { field: "sumTotalAmount", title: "总金额", minWidth: 120, showHeaderOverflow: true, showOverflow: true, },
      { field: "explanation", title: "说明", minWidth: 120, showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserName", title: "申请人", minWidth: 120, showHeaderOverflow: true, showOverflow: true, },
      { field: "applyTime", title: "申请时间", minWidth: 120, showHeaderOverflow: true, showOverflow: true, },

      {
        field: "", title: "审核状态", minWidth: 120, showOverflow: true,
        slots: {
          default: ({ row }) => {
            let a
