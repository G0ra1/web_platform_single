...
export default defineComponent({
  ...
  setup() {
    ...
    const columns = reactive([
      ...
      {
        field: "code", title: "入库编号", showHeaderOverflow: true, showOverflow: true, slots: {
          default: ({ row }) => {
            return <span onClick={() => { showDetails(row) }} style="color:#1d7ced;cursor: pointer;">{row.code}</span>
          }
        }
      },
      { field: "acceptanceCode", title: "验收单号", showHeaderOverflow: true, showOverflow: true, },
      { field: "assetSourceName", title: "物资来源", showHeaderOverflow: true, showOverflow: true, },
      { field: "sumTotalNumber", title: "入库数量", showHeaderOverflow: true, showOverflow: true, },
      { field: "sumTotalAmount", title: "入库金额", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserName", title: "入库申请人", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserDeptName", title: "入库申请部门", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserOrgName", title: "入库申请单位", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyTime", title: "入库申请时间", showHeaderOverflow: true, showOverflow: true, },
      {
...
/*
      { field: "assigneeName", title: "当前审批人", showHeaderOverflow: true, showOverflow: true, },
*/
