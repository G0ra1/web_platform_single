...
export function query(data) {
  return request({
    url: `/asset/purchaseStorage/list`,
    method: 'post',
    data
  })
}
...
export function getUpTask(taskLevel) {
  return request({
    url: `/asset/purchaseStorage/getUpTask/${taskLevel}`,
    method: 'get',
  })
}
...
export function getChildTask(parentId) {
  return request({
    url: `/asset/purchaseStorage/getChildTask/${parentId}`,
    method: 'post',
  })
}
...
export function getTreeTask(level) {
  return request({
    url: `/asset/purchaseStorage/getTreeTask/${level}`,
    method: 'get',
  })
}
