...
export function query(data) {
  return request({
    url: `/asset/purchaseRegister/list`,
    method: 'post',
    data
  })
}
...
export function getUpTask(taskLevel) {
  return request({
    url: `/asset/purchaseRegister/getUpTask/${taskLevel}`,
    method: 'get',
  })
}
...
export function getChildTask(parentId) {
  return request({
    url: `/asset/purchaseRegister/getChildTask/${parentId}`,
    method: 'post',
  })
}
...
export function getTreeTask(level) {
  return request({
    url: `/asset/purchaseRegister/getTreeTask/${level}`,
    method: 'get',
  })
}
