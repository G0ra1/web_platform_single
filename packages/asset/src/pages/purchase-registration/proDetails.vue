    ...
    <n-drawer-content title="物资详情">
      <div class="manhour-details">
        ...
        <div class="manhour">
          ...
          <div>
            <span>购置申请</span><span>{{ dataModel.applyCode }}</span>
          </div>
          <div>
            <span>采购合同</span><span>{{ dataModel.contractCode }}</span>
          </div>
          <div>
            <span>供应商</span><span>{{ dataModel.supplierName }}</span>
          </div>
          <div>
            <span>合同签订时间</span><span>{{ dataModel.contractTime }}</span>
          </div>
          <div>
