...
export function del(id) {
  return request({
    url: `/asset/materialDistribute/${id}`,
    method: 'delete',
  })
}
// 编辑接口
...
export function query(data) {
  return request({
    url: `/asset/materialDistribute/list`,
    method: 'post',
    data
  })
}
...
export function getUpTask(taskLevel) {
  return request({
    url: `/asset/materialDistribute/getUpTask/${taskLevel}`,
    method: 'get',
  })
}
...
export function getChildTask(parentId) {
  return request({
    url: `/asset/materialDistribute/getChildTask/${parentId}`,
    method: 'post',
  })
}
...
export function getTreeTask(level) {
  return request({
    url: `/asset/materialDistribute/getTreeTask/${level}`,
    method: 'get',
  })
}
