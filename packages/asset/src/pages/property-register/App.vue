        ...
        <n-layout class="nw-layout-full">
            ...
            <n-layout-header class="nw-layout-header">
                <n-space :size="5" style="padding: 0 5px">
                    <!--放功能按钮的地方-->
                    <NwFunctionPredefine code="assetPropertyRegisterFormAdd" :params="paramsArray" />
                </n-space>
                <n-space :size="5" style="padding: 0 5px">
                    <n-input-group>
                        <n-input :value="filterData.code || ''" @update:value="(d: string) => filterData.code = d"
                            placeholder="知识产权编号" :style="{ width: '150px' }" style="margin-right: 10px" />
                        <n-input :value="filterData.name || ''" @update:value="(d: string) => filterData.name = d"
                            placeholder="知识产权名称" :style="{ width: '150px' }" style="margin-right: 10px" />
