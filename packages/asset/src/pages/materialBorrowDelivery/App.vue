...
import { NLayout, NLayoutHeader, NLayoutContent, NSpace, NInput, NInputGroup, useDialog, NButton } from 'naive-ui'
        ...
        <n-layout class="nw-layout-full">
            ...
            <n-layout-header class="nw-layout-header">
                <n-space :size="5" style="padding: 0 5px">
                    <!--放功能按钮的地方-->
                    <NwFunctionPredefine code="materialBorrowDeliveryFormAdd" :params="paramsArray" />
                </n-space>
                <n-space :size="5" style="padding: 0 5px">
                    <n-input-group>
                        ...
                        <n-input :value="filterData.needDeptName || ''" @update:value="(d: string) => filterData.needDeptName = d"
                            placeholder="需用部门" :style="{ width: '150px' }" style="margin-right: 10px" />
                        <n-input :value="filterData.borrowState || ''" @update:value="(d: string) => filterData.borrowState = d"
                            placeholder="借用状态" :style="{ width: '150px' }" style="margin-right: 10px" />
