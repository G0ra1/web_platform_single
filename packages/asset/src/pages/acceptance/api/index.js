...
export function getUpTask(taskLevel) {
  return request({
    url: `/asset/purchaseAccept/getUpTask/${taskLevel}`,
    method: 'get',
  })
}
...
export function getChildTask(parentId) {
  return request({
    url: `/asset/purchaseAccept/getChildTask/${parentId}`,
    method: 'post',
  })
}
...
export function getTreeTask(level) {
  return request({
    url: `/asset/purchaseAccept/getTreeTask/${level}`,
    method: 'get',
  })
}
