<template>
  ...
  padding: '10px',
      ...
      <nw-form-view ref="formRef" src="/html/forms/asset-withdrawal-form.html" />
      <template #footer>
...
export default defineComponent({
  ...
  setup() {
    ...
    const columns = reactive([
      ...
      {
        field: "code", title: "退库编号", showHeaderOverflow: true, showOverflow: true, slots: {
          default: ({ row }) => {
            return <span onClick={() => { showDetails(row) }} style="color:#1d7ced;cursor: pointer;">{row.code}</span>
          }
        }
      },
      { field: "applyUserOrgName", title: "退库申请单位", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserDeptName", title: "退库申请部门", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyUserName", title: "退库申请人", showHeaderOverflow: true, showOverflow: true, },
      { field: "applyTime", title: "退库申请时间", showHeaderOverflow: true, showOverflow: true, },
      {
    ...
    top: -1px;"></span>
      ...
      //{ field: "applyTime", title: "当前审批人", showHeaderOverflow: true, showOverflow: true, },
      {
        field: "",
        title: "操作",
        fixed: 'right',
