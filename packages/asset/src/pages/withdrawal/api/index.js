...
export function del(id) {
  return request({
    url: `/asset/materialWithdrawal/${id}`,
    method: 'delete',
  })
}
// 编辑接口
...
export function query(data) {
  return request({
    url: `/asset/materialWithdrawal/list`,
    method: 'post',
    data
  })
}
...
export function getUpTask(taskLevel) {
  return request({
    url: `/asset/materialWithdrawal/getUpTask/${taskLevel}`,
    method: 'get',
  })
}
...
export function getChildTask(parentId) {
  return request({
    url: `/asset/materialWithdrawal/getChildTask/${parentId}`,
    method: 'post',
  })
}
...
export function getTreeTask(level) {
  return request({
    url: `/asset/materialWithdrawal/getTreeTask/${level}`,
    method: 'get',
  })
}
...
export function getmaterialWithdrawal(id) {
  return request({
    url: `/asset/materialWithdrawal/${id}`,
    method: "get",
  });
