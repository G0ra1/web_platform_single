        ...
        <n-grid x-gap="8" :cols="2" >
            <n-grid-item>
             ...
             <n-grid-item>
                <n-form-item path="userNameCh" label="姓名">
                    <n-input
                        v-model:value="model.userNameCh"
                    />
                </n-form-item>
            </n-grid-item>
            ...
            <n-grid-item>
                <n-form-item path="nationality" label="国籍">
                     <n-select
                       filterable
                        v-model:value="model.nationality"
                        placeholder="请选择国籍"
            ...
            <n-grid-item>
             ...
             <n-grid-item>
                <!-- <n-form-item path="" label="新岗位">
                  ...
                  /> -->
                 <n-form-item path="" label="新岗位">
                    <n-input  class="my-search" placeholder="" disabled :value="model.mdmPostUserDto ?model.mdmPostUserDto.postName:'' ">
                        <template #suffix>
                            <n-button type="info"   @Click="(e)=>{showPostPickModal({parentDeptId:model.parentDeptId})}">选择</n-button>
                        </template>
                    </n-input>
                </n-form-item>
