...
import CemlabExperimentProcess from "./processModel";
export default class CemlabExperimentReceipts {
    ...
    isDel: number = 0;
    //实验过程
    cemlabExperimentProcess!: CemlabExperimentProcess;
    //实验条件
    ...
    //实验过程列表
    experimentProcessList: Array<CemlabExperimentProcess> = new Array();
}