 ...
 * @date 2023-02-08 16:44:07
 */
import CemlabExperimentProcessCondition from './proccessConditionModel'
import CemlabExperimentProcessResult from './processResults'
export default class CemlabExperimentProcess {
    ...
    isDel!: number;
    //实验过程条件
    cemlabExperimentProcessConditionList: Array<CemlabExperimentProcessCondition> = new Array();
    //实验过程结果
    cemlabExperimentProcessResultList: Array<CemlabExperimentProcessResult> = new Array();
}