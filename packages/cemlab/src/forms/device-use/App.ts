...
class FormModal extends AbstractForm {
  ...
  setValue = (d: object) => {
    getDeviceNameList({}).then((d) => {
      this.deviceNameList.value = d;
    });
  ...
  columns = [
    ...
    },
    {
      ...
      title: "使用时间",
      editRender: { enabled: true },
      slots: { edit: "useTimes", default: "useTimes" },
      showHeaderOverflow: true,
      minWidth: "280px",
      align: "center",
    },
    {
      field: "useBeforeStatus",
      title: "使用前",
      editRender: { enabled: false },
      slots: { edit: "useBeforeStatus", default: "useBeforeStatus" },
      showHeaderOverflow: true,
      minWidth: "180px",
      align: "center",
    },
    {
      field: "useAfterStatus",
      title: "使用后",
      editRender: { enabled: false },
      slots: { edit: "useAfterStatus", default: "useAfterStatus" },
      showHeaderOverflow: true,
      minWidth: "180px",
      align: "center",
    },
