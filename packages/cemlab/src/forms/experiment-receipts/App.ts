...
const bind = reactive<VxeGridProps>({
    columns: [
        { field: 'slurryType', title: '浆体类型', showHeaderOverflow: false, minWidth: '160px', align: 'center', editRender: {}, slots: { default: 'slurryType_default' } },
        { field: 'density', title: '密度', showHeaderOverflow: false, minWidth: '160px', align: 'center', editRender: {}, slots: { edit: 'density_edit' } },
        { field: 'filterLoss', title: '滤失量', showHeaderOverflow: true, minWidth: '160px', align: 'center', editRender: {}, slots: { edit: 'filterLoss_edit' } },
        { field: 'freeFluid', title: '游离液', showHeaderOverflow: true, minWidth: '160px', align: 'center', editRender: {}, slots: { edit: 'freeFluid_edit' } },
        { field: 'cementConsistency', title: '水泥浆稠度', showHeaderOverflow: true, minWidth: '160px', align: 'center', editRender: {}, slots: { edit: 'cementConsistency_edit' } },
        { field: 'thickeningTime', title: '稠化时间', showHeaderOverflow: true, minWidth: '160px', align: 'center', editRender: {}, slots: { edit: 'thickeningTime_edit' } },
        { field: 'compressiveStrength', title: '抗压强度', showHeaderOverflow: true, minWidth: '160px', align: 'center', editRender: {}, slots: { edit: 'compressiveStrength_edit' } },
        { field: 'compressiveStrengthTime', title: '抗压强度时间', showHeaderOverflow: true, minWidth: '160px', align: 'center', editRender: {}, slots: { edit: 'compressiveStrengthTime_edit' } },
        { field: 'fluidity', title: '流动度', showHeaderOverflow: true, minWidth: '160px', align: 'center', editRender: {}, slots: { edit: 'fluidity_edit' } },
    ],
    editConfig: {
        trigger: 'click',
        mode: 'cell',
