<template>
  ...
  >
    <n-spin :show="isLoading">
      <n-form  style="padding:10px" :model="model.data" ref="formRef" :rules="rules">
...
export default defineComponent({
  ...
  setup (props,context) {
    ...
    const parentList = reactive([{ label: '污染实验配方', key: 'CONTAMINATE_TYPE', id:'CONTAMINATE_TYPE',children:[]}])
    ...
    const sonFn = (data={}) => {
      ...
      allClassifys('CONTAMINATE_TYPE').then((res)=>{
           const getStr = (list)=>{
                list.forEach((row)=>{
