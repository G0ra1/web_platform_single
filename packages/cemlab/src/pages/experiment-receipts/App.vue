...
import { NLayout, NLayoutHeader, NLayoutContent, NSpace, NInput, NSelect, NInputGroup, useDialog, NButton, NPopselect, NPopover } from 'naive-ui'
import { bind, gridRef, filterData, query, refresh, reset, paramsArray, initDialog } from "./App"
import { nextTick, inject, h } from 'vue'
        ...
        <n-layout class="nw-layout-full">
            ...
            <n-layout-header class="nw-layout-header">
                <n-space :size="5" style="padding: 0 5px">
                    <!--放功能按钮的地方-->
                    <n-popover placement="bottom" trigger="click" display-directive="show">
                        <template #trigger>
                            <n-button>新增</n-button>
                        </template>
                        <div>
                            <NwFunctionPredefine code="experimentReceiptsFormAdd" :params="paramsArray" />
                        </div>
                        <div style="margin-top: 10px;">
                            <NwFunctionPredefine code="experimentReceiptsOutFormAdd" :params="paramsArray" />
                        </div>
                    </n-popover>
                </n-space>
                <n-space :size="5" style="padding: 0 5px">
                    <n-input-group>
                        <n-input :value="filterData.code || ''" @update:value="(d: string) => filterData.code = d"
                            placeholder="单号" :style="{ width: '150px' }" style="margin-right: 10px" />
