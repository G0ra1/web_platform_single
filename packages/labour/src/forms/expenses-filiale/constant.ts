...
const ExpensesFilialeWpnColumn = [
    ...
    {
        field: 'startDateTime', title: '开始时间', showHeaderOverflow: true, width: '150px', align: 'center',
        slots: {
    ...
    {
        field: 'endDateTime', title: '结束时间', showHeaderOverflow: true, width: '150px', align: 'center',
        slots: {
    ...
    {
        field: 'stayLength', title: '住宿天数', showHeaderOverflow: true, width: '150px', align: 'center',
        slots: {
            default: 'stayLength_view',
            edit:({row}:any)=>{
            let start = (new Date(row.startDateTime).getDate() || 0)
            let end  = (new Date(row.endDateTime).getDate() || 0)
            if(start == 1 ){
                start = 0 
            }
           if(start == 1 && end == 1){
                return [ row.stayLength = 1]
           }
            row.stayLength  =  (end  -  start) 
                return [
                    row.stayLength 
                ]
    ...
    {
        field: 'electricityCost', title: '电费', showHeaderOverflow: true, width: '150px', align: 'center',
        slots: {
    ...
    {
        field: 'waterCost', title: '水费', showHeaderOverflow: true, width: '150px', align: 'center',
        slots: {
    ...
    {
        field: 'netCost', title: '网费', showHeaderOverflow: true, width: '150px', align: 'center',
        slots: {
    ...
    {
        field: 'total', title: '合计', showHeaderOverflow: true, width: '150px', align: 'center',
        slots: {
            default: ({ row }: any) => {
    ...
    {
        field: 'remark', title: '备注', showHeaderOverflow: true, width: '150px', align: 'center',
        slots: {
            default: 'remark_view',
            edit: 'remark_edit',
        }
    ...
    {
        field: 'attachment', title: '附件信息', width: '350px',showHeaderOverflow: true, align: 'center',
        slots: {
...
const ExpensesFilialeAssessColumn = [
    ...
    {
        field: 'entranceValidity', title: '入场有效性', showHeaderOverflow: false, align: 'center',  width: '200px',
        slots: {
    ...
    {
        field: 'checkupValidity', title: '体检有效性', showHeaderOverflow: false, align: 'center',width: '200px',
        slots: {
    ...
    {
        field: 'total', title: '合计', showHeaderOverflow: true, align: 'center',
        slots: {
            default: ({ row }: any) => {
                return [row.total]
            },
    ...
    {
        field: 'remark', title: '备注', showHeaderOverflow: true, align: 'center',
        slots: {
            default: 'remark_view',
            edit: 'remark_edit',
        }
...
const ExpensesFilialeFestival = [
    ...
    { field: 'suppUserName', title: '劳务人员名称', showHeaderOverflow: true, editRender: { enabled: false }, align: 'center', },
    {
        field: 'festivalCost', title: '过节费金额', showHeaderOverflow: true, align: 'center',
        slots: {
    ...
    {
        field: 'total', title: '合计金额', showHeaderOverflow: true, align: 'center',
        slots: {
            default: ({ row }: any) => {
                row.total = (row.festivalCost)
                return [
                    row.total.toFixed(2)
                ]
            },
...
const ExpensesFilialeRewardPunish = [
    ...
    {
        field: 'rewardCost', title: '奖励费用', showHeaderOverflow: true, align: 'center',width: '150px',
        slots: {
    ...
    {
        field: 'punishmentCost', title: '惩罚费用', showHeaderOverflow: true, align: 'center',width: '150px',
        slots: {
    ...
    {
        field: 'otherDeductionsCost', title: '其他扣款', showHeaderOverflow: true, align: 'center',width: '150px',
        slots: {
    ...
    {
        field: 'total', title: '合计金额', showHeaderOverflow: true, align: 'center',width: '150px',
        slots: {
            default: ({ row }: any) => {
    ...
    {
        field: 'remark', title: '备注', showHeaderOverflow: true, align: 'center',width: '150px',
        slots: {
            default: 'remark_view',
            edit: 'remark_edit',
        }
    ...
    {
        field: 'attachment', title: '附件信息', width: '200px',showHeaderOverflow: true, align: 'center',
        slots: {
            default: 'attachment_view',
            edit: 'attachment_edit'
        }
