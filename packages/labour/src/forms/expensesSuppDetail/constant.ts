...
const ExaminationColumn = [
  ...
  {
    field: 'examinationCost', title: '体检费用', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NInputNumber,
        {
  ...
  {
    field: 'attachment', title: '附件信息', showOverflow: "title", editRender: { enabled: false },
    slots: {
...
const NucleicacidColumn = [
  ...
  { field: 'idCard', title: '身份证号', editRender: { enabled: false }, },
  {
    field: 'nucleicAcidReachCost', title: '到场核酸检测费', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NInputNumber,
        {
  ...
  {
    field: 'nucleicAcidBackCost', title: '返程核酸检测费', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NInputNumber,
        {
...
const TravelColumn = [
  ...
  {
    field: 'startingCity', title: '出发地点', width: '200px', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NInput,
        {
  ...
  {
    field: 'arriveCity', title: '到达地点', width: '200px', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NInput,
        {
  ...
  {
    field: 'startingDate', title: '出发时间', width: '200px', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NDatePicker,
        {
  ...
  {
    field: 'arriveDate', title: '到达时间', width: '200px', editRender: { enabled: false }, slots: {
      edit: ({ row }: any) => [h(
        NDatePicker,
        {
  ...
  {
    field: 'vehicle', title: '交通工具', width: '200px', editRender: { enabled: false },
        slots: {
  ...
  {
    field: 'ticketAmount', title: '票据金额', width: '200px', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NInputNumber,
        {
  ...
  {
    field: 'accommodationAmount', title: '住宿费', width: '200px', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NInputNumber,
        {
  ...
  {
    field: 'remark', title: '备注', width: '200px', editRender: { enabled: false },
    slots: {
      edit: ({ row }: any) => [h(
        NInput,
        {
  ...
  {
    field: 'attachment', title: '附件信息', width: '300px', showOverflow: "title", editRender: { enabled: false },
    slots: {
      edit: 'attachment_edit',
      default: 'attachment_view'
    }
