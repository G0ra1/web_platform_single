<template>
  <n-layout class="nw-layout-full" >
    <n-layout-header class="nw-layout-header" >
      ...
      <n-space :size="10" style="padding: 0 5px">
        <n-input-group>
          <n-input :value="filterData.overhaulRotation || ''"
           @update:value="(d) =>  filterData.overhaulRotation = d"
            placeholder="测试" :style="{ width: '150px' }" />
           
          <n-button type="primary" @click="query()">
            搜索
          </n-button>
        </n-input-group>
        <n-button  title="重置" type="info" @click="refresh()">
          <template #icon>
