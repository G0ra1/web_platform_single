        ...
        <n-layout class="nw-layout-full">
            ...
            <n-layout-header class="nw-layout-header">
                <n-space :size="5" style="padding: 0 5px">
                    <!--放功能按钮的地方-->
                    <NwFunctionPredefine code="labourAttendanceVacateDetailsForm_add" :params="paramsArray" />
                </n-space>
                <n-space :size="5" style="padding: 0 5px">
                    <n-input-group>
                        <n-input :value="filterData.vacateId || ''" @update:value="(d: string) => filterData.vacateId = d"
                            placeholder="请假表id" :style="{ width: '150px' }" style="margin-right: 10px" />
                        <n-input :value="filterData.vacateDate || ''" @update:value="(d: string) => filterData.vacateDate = d"
                            placeholder="请假日期" :style="{ width: '150px' }" style="margin-right: 10px" />
                        <n-input :value="filterData.vacateLenth || ''" @update:value="(d: string) => filterData.vacateLenth = d"
                            placeholder="请假时长：1全天、2上午、3下午" :style="{ width: '150px' }" style="margin-right: 10px" />
