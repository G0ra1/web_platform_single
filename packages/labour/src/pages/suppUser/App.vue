...
import { bind, gridRef, filterData, query, refresh, reset, paramsArray, initDialog, sexOptions } from "./App"
    ...
    <n-layout has-sider class="nw-layout-full">
        ...
        <n-layout class="nw-layout-full">
            ...
            <n-layout-header class="nw-layout-header">
                ...
                <n-space :size="5" style="padding: 0 5px">
                    <n-input-group>
                        <n-input :value="filterData.phoneNum || ''"
                            @update:value="(d: string) => filterData.phoneNum = d" placeholder="手机号"
                            :style="{ width: '150px' }" style="margin-right: 10px" />
                        <n-select v-model:value="filterData.sex" :options="sexOptions"
                            @update:value="(d: string) => filterData.sex = d" placeholder="请选择"
                            :style="{ width: '150px' }">
                        </n-select>
                        <n-input :value="filterData.idCard || ''" @update:value="(d: string) => filterData.idCard = d"
